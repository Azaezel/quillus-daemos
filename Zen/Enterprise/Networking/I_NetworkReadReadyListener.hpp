...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_NETWORKING_I_NETWORK_READ_READY_LISTENER_HPP_INCLUDED
#define ZEN_NETWORKING_I_NETWORK_READ_READY_LISTENER_HPP_INCLUDED
...
class NETWORKING_DLL_LINK I_NetworkReadReadyListener
{
...
#endif // ZEN_NETWORKING_I_NETWORK_READ_READY_LISTENER_HPP_INCLUDED
