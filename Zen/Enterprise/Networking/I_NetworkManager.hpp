...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_NETWORKING_I_NETWORK_MANAGER_HPP_INCLUDED
#define ZEN_NETWORKING_I_NETWORK_MANAGER_HPP_INCLUDED
...
class NETWORKING_DLL_LINK I_NetworkManager
{
    /// @name Types
    /// @{
public:
...
#endif // ZEN_NETWORKING_I_NETWORK_MANAGER_HPP_INCLUDED
