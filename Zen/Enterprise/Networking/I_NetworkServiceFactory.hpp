...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_NETWORKING_I_NETWORK_SERVICE_FACTORY_HPP_INCLUDED
#define ZEN_NETWORKING_I_NETWORK_SERVICE_FACTORY_HPP_INCLUDED
...
#endif // ZEN_NETWORKING_I_NETWORK_SERVICE_FACTORY_HPP_INCLUDED
