...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_NETWORKING_I_NETWORK_ADDRESS_FACTORY_HPP_INCLUDED
#define ZEN_NETWORKING_I_NETWORK_ADDRESS_FACTORY_HPP_INCLUDED
...
#endif // ZEN_NETWORKING_I_NETWORK_ADDRESS_FACTORY_HPP_INCLUDED
