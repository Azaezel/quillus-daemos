...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_NETWORKING_I_NETWORK_CONNECTION_LISTENER_HPP_INCLUDED
#define ZEN_NETWORKING_I_NETWORK_CONNECTION_LISTENER_HPP_INCLUDED
...
#endif // ZEN_NETWORKING_I_NETWORK_CONNECTION_LISTENER_HPP_INCLUDED
