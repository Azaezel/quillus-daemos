...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_APPSERVER_I_REQUEST_HANDLER_HPP_INCLUDED
#define ZEN_APPSERVER_I_REQUEST_HANDLER_HPP_INCLUDED
...
#endif // ZEN_APPSERVER_I_REQUEST_HANDLER_HPP_INCLUDED
