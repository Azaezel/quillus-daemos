...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_APPSERVER_RESOURCE_LOCATION_HPP_INCLUDED
#define ZEN_APPSERVER_RESOURCE_LOCATION_HPP_INCLUDED
...
#endif // ZEN_APPSERVER_RESOURCE_LOCATION_HPP_INCLUDED
