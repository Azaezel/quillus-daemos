...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_APPSERVER_I_APPLICATION_SERVICE_FACTORY_HPP_INCLUDED
#define ZEN_APPSERVER_I_APPLICATION_SERVICE_FACTORY_HPP_INCLUDED
...
class APPSERVER_DLL_LINK I_ApplicationServiceFactory
...
#endif // ZEN_APPSERVER_I_APPLICATION_SERVICE_FACTORY_HPP_INCLUDED
