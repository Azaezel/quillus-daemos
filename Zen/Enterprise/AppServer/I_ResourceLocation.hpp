...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_APPSERVER_I_RESOURCE_LOCATION_HPP_INCLUDED
#define ZEN_APPSERVER_I_RESOURCE_LOCATION_HPP_INCLUDED
...
///
///
class APPSERVER_DLL_LINK I_ResourceLocation
:   boost::noncopyable
{
    /// @name Types
    /// @{
...
#endif // ZEN_APPSERVER_I_RESOURCE_LOCATION_HPP_INCLUDED
