...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_APPSERVER_I_MESSAGE_TYPE_HPP_INCLUDED
#define ZEN_APPSERVER_I_MESSAGE_TYPE_HPP_INCLUDED
...
class APPSERVER_DLL_LINK I_MessageType
:   boost::noncopyable
{
    /// @name Types
    /// @{
...
#endif // ZEN_APPSERVER_I_MESSAGE_TYPE_HPP_INCLUDED
