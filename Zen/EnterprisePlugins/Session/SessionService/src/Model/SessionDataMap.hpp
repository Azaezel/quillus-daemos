...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ENTERPRISE_SESSION_MODEL_SESSION_DATA_MAP_HPP_INCLUDED
#define ZEN_ENTERPRISE_SESSION_MODEL_SESSION_DATA_MAP_HPP_INCLUDED
...
public:
    ...
    /// @name I_SessionDataMap implementation
    /// @{
public:
    ...
    /// @name SessionDataMap implementation
    /// @{
public:
    ...
    /// sans the primary key (sessionId)
    ...
    /// @{
public:
             SessionDataMap(pDatabaseConnection_type _pDatabaseConnection);
    virtual ~SessionDataMap();
    /// @}
...
#endif // ZEN_ENTERPRISE_SESSION_MODEL_SESSION_DATA_MAP_HPP_INCLUDED
