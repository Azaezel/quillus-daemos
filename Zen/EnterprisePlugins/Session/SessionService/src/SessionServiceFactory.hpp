...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ENTERPRISE_SESSION_SERVICE_SESSION_SERVICE_FACTORY_HPP_INCLUDED
#define ZEN_ENTERPRISE_SESSION_SERVICE_SESSION_SERVICE_FACTORY_HPP_INCLUDED
...
public:
    ...
    /// @name SessionServiceFactory implementation
    /// @{
private:
...
public:
    ...
    static SessionServiceFactory& getSingleton();
    /// @}
...
#endif // ZEN_ENTERPRISE_SESSION_SERVICE_SESSION_SERVICE_FACTORY_HPP_INCLUDED
