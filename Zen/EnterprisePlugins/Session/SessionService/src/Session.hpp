...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ENTERPRISE_SESSION_SERVER_SESSION_HPP_INCLUDED
#define ZEN_ENTERPRISE_SESSION_SERVER_SESSION_HPP_INCLUDED
...
public:
    ...
    public:
        ...
        /// @{
    public:
        boost::uint64_t getRawSessionId() const { return m_nativeSessionId; }
        /// @}
...
public:
             ...
             Session(boost::uint64_t _nativeSessionId, pEndpoint_type _pDestination, pResourceLocation_type _pLocation, SessionState_type _status);
	virtual ~Session();
	/// @}
...
private:
    ...
    /// TODO Once Account services are implemented,
    /// add account and session time information in
    /// sessions subscribed to by Session::Server
...
#endif // ZEN_ENTERPRISE_SESSION_SERVER_SESSION_HPP_INCLUDED
