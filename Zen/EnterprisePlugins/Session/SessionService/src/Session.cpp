...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
Session::Session(boost::uint64_t _nativeSessionId, 
                 pEndpoint_type _pDestination, 
                 pResourceLocation_type _pLocation,
                 SessionState_type _status)
:   m_sessionId(new NativeSessionId(_nativeSessionId))
,   m_pEndpoint(_pDestination)
,   m_pLocation(_pLocation)
,	m_sessionState(_status)
,	m_pScriptObject(NULL)
{
}
