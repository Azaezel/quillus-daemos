...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ENTERPRISE_SESSION_PROTOCOL_I_LOGIN_RESPONSE_HPP_INCLUDED
#define ZEN_ENTERPRISE_SESSION_PROTOCOL_I_LOGIN_RESPONSE_HPP_INCLUDED
...
class SESSION_CLIENT_DLL_LINK I_LoginResponse
...
namespace Memory {
    ...
    template<>
    struct is_managed_by_factory<Zen::Enterprise::Session::Protocol::I_LoginResponse> 
    :   public boost::true_type{};
}   // namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_ENTERPRISE_SESSION_PROTOCOL_I_LOGIN_RESPONSE_HPP_INCLUDED
