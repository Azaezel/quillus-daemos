...
SessionServiceFactory::create(Zen::Enterprise::AppServer::I_ApplicationServer& _appServer, const std::string& _type)
{
    ...
    typedef Memory::managed_ptr<Enterprise::Session::Client::I_SessionService>       pSessionService_type;
    typedef Memory::managed_weak_ptr<Enterprise::Session::Client::I_SessionService>  wpSessionService_type;
