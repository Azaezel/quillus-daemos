...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ENTERPRISE_SESSION_PROTOCOL_LOGIN_RESPONSE_HPP_INCLUDED
#define ZEN_ENTERPRISE_SESSION_PROTOCOL_LOGIN_RESPONSE_HPP_INCLUDED
...
#endif // ZEN_ENTERPRISE_SESSION_PROTOCOL_LOGIN_RESPONSE_HPP_INCLUDED
