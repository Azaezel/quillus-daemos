...
:   Request(LoginRequest::createMessageHeader(getNewMessageId(), _pSrcLocation->toString(), _pDestLocation->toString()), _pSourceEndpoint, _pDestinationEndpoint)
{
}
...
LoginRequest::createMessageHeader(boost::uint64_t _messageId, const std::string& _srcLocation, const std::string& _destLocation)
{
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
LoginRequest::destroy(wpRequest_type _wpRequest)
{
    LoginRequest* pRequest = 
        dynamic_cast<LoginRequest*>(_wpRequest.get());
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
LoginRequest::pMessageType_type
LoginRequest::getStaticMessageType()
{
    return sm_pType;
}
