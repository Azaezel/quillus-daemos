...
namespace Protocol {
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
LogoutResponse::pMessageType_type LogoutResponse::sm_pType;
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
Zen::Enterprise::AppServer::I_MessageRegistry* LogoutResponse::sm_pMessageRegistry = NULL;
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
LogoutResponse::LogoutResponse(pEndpoint_type _pSourceEndpoint,
                             pEndpoint_type _pDestinationEndpoint,
                             pResourceLocation_type _pSrcLocation,
                             pResourceLocation_type _pDestLocation,
                             boost::uint64_t _requestMessageId)
:   Response(LogoutResponse::createMessageHeader(getNewMessageId(), _requestMessageId, _pSrcLocation->toString(), _pDestLocation->toString()), _pSourceEndpoint, _pDestinationEndpoint)
,   m_session()
{
}

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
LogoutResponse::LogoutResponse(pMessageHeader_type _pMessageHeader,
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
LogoutResponse::serialize(pMessageHeader_type _pHeader, boost::archive::polymorphic_iarchive& _archive, const int _version)
{
    _archive & m_session;
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
LogoutResponse::serialize(boost::archive::polymorphic_oarchive& _archive, const int _version)
{
    _archive & m_session;
}
...
LogoutResponse::getSession() const
{
    return m_session;
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
LogoutResponse::setSession(const Enterprise::Session::I_Session& _session)
{
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
LogoutResponse::registerMessage(Zen::Enterprise::AppServer::I_ApplicationServer& _appServer)
{
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
LogoutResponse::pMessageHeader_type
LogoutResponse::createMessageHeader(boost::uint64_t _messageId, boost::uint64_t _requestId, const std::string& _srcLocation, const std::string& _destLocation)
{
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
LogoutResponse::destroy(wpResponse_type _wpResponse)
{
    LogoutResponse* pResponse = dynamic_cast<LogoutResponse*>(_wpResponse.get());
    ...
    {
        throw Zen::Utility::runtime_exception("LogoutResponse::destroy() : Invalid type.");
    }
}

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
LogoutResponse::pMessageType_type
LogoutResponse::getStaticMessageType()
{
    return sm_pType;
}
