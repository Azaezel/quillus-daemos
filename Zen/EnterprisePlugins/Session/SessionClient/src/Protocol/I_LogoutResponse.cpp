...
namespace Protocol {
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
I_LogoutResponse::I_LogoutResponse()
{
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
I_LogoutResponse::pResponse_type
I_LogoutResponse::create(pEndpoint_type _pSourceEndpoint,
                        ...
                        boost::uint64_t _requestMessageId)			   
{
    ...
    return pResponse_type(
        (Response*)pLogoutResponse, 
        LogoutResponse::destroy
    );
}

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
I_LogoutResponse::pMessageType_type
I_LogoutResponse::getStaticMessageType()			   
{
    return LogoutResponse::sm_pType;
}
