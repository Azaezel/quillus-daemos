...
namespace Protocol {
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
I_LogoutRequest::I_LogoutRequest()
{
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
I_LogoutRequest::pRequest_type
I_LogoutRequest::create(pEndpoint_type _pSourceEndpoint,
                        ...
                        pResourceLocation_type _pDestLocation)			   
{
    ...
    return pRequest_type(
        (Request*)pLogoutRequest, 
        LogoutRequest::destroy
    );
}

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
I_LogoutRequest::pMessageType_type
I_LogoutRequest::getStaticMessageType()			   
{
    return LogoutRequest::sm_pType;
}
