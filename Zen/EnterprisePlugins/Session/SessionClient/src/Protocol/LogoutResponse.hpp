...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ENTERPRISE_SESSION_PROTOCOL_LOGOUT_RESPONSE_HPP_INCLUDED
#define ZEN_ENTERPRISE_SESSION_PROTOCOL_LOGOUT_RESPONSE_HPP_INCLUDED
...
public:
    ...
    /// @{
public:
    virtual const Session::I_Session& getSession() const;
    virtual void setSession(const Session::I_Session& _session);
    /// @}
...
protected:
    ...
    friend class MessageFactory;
             ...
             LogoutResponse(pMessageHeader_type _pMessageHeader,
...
private:
    ...
    Enterprise::Session::Client::Session                    m_session;
    /// @}
...
#endif // ZEN_ENTERPRISE_SESSION_PROTOCOL_LOGOUT_RESPONSE_HPP_INCLUDED
