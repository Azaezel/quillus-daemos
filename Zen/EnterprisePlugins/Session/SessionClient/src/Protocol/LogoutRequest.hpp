...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ENTERPRISE_SESSION_PROTOCOL_LOGOUT_REQUEST_HPP_INCLUDED
#define ZEN_ENTERPRISE_SESSION_PROTOCOL_LOGOUT_REQUEST_HPP_INCLUDED
...
protected:
    ...
    friend class MessageFactory;
             ...
             LogoutRequest(pMessageHeader_type _pMessageHeader,
...
#endif // ZEN_ENTERPRISE_SESSION_PROTOCOL_LOGOUT_REQUEST_HPP_INCLUDED
