...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ENTERPRISE_ACCOUNT_CLIENT_ACCOUNT_SERVICE_HPP_INCLUDED
#define ZEN_ENTERPRISE_ACCOUNT_CLIENT_ACCOUNT_SERVICE_HPP_INCLUDED
...
#endif // ZEN_ENTERPRISE_ACCOUNT_CLIENT_ACCOUNT_SERVICE_HPP_INCLUDED
