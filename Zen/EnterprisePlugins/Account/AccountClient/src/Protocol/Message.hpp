...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ENTERPRISE_ACCOUNT_PROTOCOL_MESSAGE_HPP_INCLUDED
#define ZEN_ENTERPRISE_ACCOUNT_PROTOCOL_MESSAGE_HPP_INCLUDED
...
class Message
:   public Zen::Enterprise::Account::Protocol::I_Message
{
    /// @name Types
    /// @{
public:
...
#endif // ZEN_ENTERPRISE_ACCOUNT_PROTOCOL_MESSAGE_HPP_INCLUDED
