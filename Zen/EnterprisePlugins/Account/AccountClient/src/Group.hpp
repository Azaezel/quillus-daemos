...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ENTERPRISE_ACCOUNT_CLIENT_GROUP_HPP_INCLUDED
#define ZEN_ENTERPRISE_ACCOUNT_CLIENT_GROUP_HPP_INCLUDED
...
public:
    ...
    /// @{
public:
    virtual const Enterprise::Account::I_Group::GroupId& getGroupId() const;
    /// @}
...
#endif // ZEN_ENTERPRISE_ACCOUNT_CLIENT_GROUP_HPP_INCLUDED
