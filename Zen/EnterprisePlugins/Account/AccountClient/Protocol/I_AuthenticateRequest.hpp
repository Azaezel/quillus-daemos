...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ENTERPRISE_ACCOUNT_PROTOCOL_I_AUTHENTICATE_REQUEST_HPP_INCLUDED
#define ZEN_ENTERPRISE_ACCOUNT_PROTOCOL_I_AUTHENTICATE_REQUEST_HPP_INCLUDED
...
class ACCOUNT_CLIENT_DLL_LINK I_AuthenticateRequest
...
public:
    ...
    /// @{
protected:
             I_AuthenticateRequest();
    virtual ~I_AuthenticateRequest();
    /// @}
...
namespace Memory {
    // I_AuthenticateRequest is managed by factory
    template<>
    struct is_managed_by_factory<Zen::Enterprise::Account::Protocol::I_AuthenticateRequest> 
    :   public boost::true_type{};
}   // namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_ENTERPRISE_ACCOUNT_PROTOCOL_I_AUTHENTICATE_REQUEST_HPP_INCLUDED
