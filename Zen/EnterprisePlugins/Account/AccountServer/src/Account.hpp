...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ENTERPRISE_ACCOUNT_SERVER_ACCOUNT_HPP_INCLUDED
#define ZEN_ENTERPRISE_ACCOUNT_SERVER_ACCOUNT_HPP_INCLUDED
...
#endif // ZEN_ENTERPRISE_ACCOUNT_SERVER_ACCOUNT_HPP_INCLUDED
