...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ENTERPRISE_ACCOUNT_MODEL_I_GROUP_DOMAIN_OBJECT_HPP_INCLUDED
#define ZEN_ENTERPRISE_ACCOUNT_MODEL_I_GROUP_DOMAIN_OBJECT_HPP_INCLUDED
...
class ACCOUNT_SERVICE_DLL_LINK I_GroupDomainObject
...
namespace Memory {
    ...
    template<>
    struct is_managed_by_factory<Zen::Enterprise::Account::Model::I_GroupDomainObject> 
    :   public boost::true_type{};
}   // namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_ENTERPRISE_ACCOUNT_MODEL_I_GROUP_DOMAIN_OBJECT_HPP_INCLUDED
