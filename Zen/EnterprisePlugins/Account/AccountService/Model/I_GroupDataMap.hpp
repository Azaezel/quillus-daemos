...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ENTERPRISE_ACCOUNT_MODEL_I_GROUP_DATA_MAP_HPP_INCLUDED
#define ZEN_ENTERPRISE_ACCOUNT_MODEL_I_GROUP_DATA_MAP_HPP_INCLUDED
...
class ACCOUNT_SERVICE_DLL_LINK I_GroupDataMap
:   public boost::noncopyable
{
    /// @name Types
    /// @{
public:
    typedef Zen::Memory::managed_ptr<I_GroupDataMap>                  pDataMap_type;

    typedef Zen::Database::I_DatabaseService::pDatabaseConnection_type  pDatabaseConnection_type;

    typedef Zen::Memory::managed_ptr<I_GroupDataCollection>           pDataCollection_type;
...
namespace Memory {
    ...
    template<>
    struct is_managed_by_factory<Zen::Enterprise::Account::Model::I_GroupDataMap> 
    :   public boost::true_type{};
}   // namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_ENTERPRISE_ACCOUNT_MODEL_I_GROUP_DATA_MAP_HPP_INCLUDED
