...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ENTERPRISE_ACCOUNT_MODEL_I_ACCOUNT_GROUP_DATA_MAP_HPP_INCLUDED
#define ZEN_ENTERPRISE_ACCOUNT_MODEL_I_ACCOUNT_GROUP_DATA_MAP_HPP_INCLUDED
...
class I_AccountGroupDomainObject;
class I_AccountGroupDataCollection;

class ACCOUNT_SERVICE_DLL_LINK I_AccountGroupDataMap
:   public boost::noncopyable
{
    /// @name Types
    /// @{
public:
    typedef Zen::Memory::managed_ptr<I_AccountGroupDataMap>                  pDataMap_type;

    typedef Zen::Database::I_DatabaseService::pDatabaseConnection_type  pDatabaseConnection_type;

    typedef Zen::Memory::managed_ptr<I_AccountGroupDataCollection>           pDataCollection_type;
    ...
    typedef Zen::Memory::managed_ptr<I_AccountGroupDomainObject>             pDomainObject_type;
    ...
    /// @name I_AccountGroupDataMap interface
    /// @{
public:
...
public:
    ...
    /// @{
protected:
             I_AccountGroupDataMap();
    virtual ~I_AccountGroupDataMap();
    /// @}

};  // interface I_AccountGroupDataMap
...
namespace Memory {
    /// I_AccountGroupDataMap is a managed by factory
    template<>
    struct is_managed_by_factory<Zen::Enterprise::Account::Model::I_AccountGroupDataMap> 
    :   public boost::true_type{};
}   // namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_ENTERPRISE_ACCOUNT_MODEL_I_ACCOUNT_GROUP_DATA_MAP_HPP_INCLUDED
