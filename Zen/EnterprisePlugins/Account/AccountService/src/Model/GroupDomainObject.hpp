...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ENTERPRISE_ACCOUNT_MODEL_GROUP_DOMAIN_OBJECT_HPP_INCLUDED
#define ZEN_ENTERPRISE_ACCOUNT_MODEL_GROUP_DOMAIN_OBJECT_HPP_INCLUDED

#include "../../Model/I_GroupDomainObject.hpp"
...
#endif // ZEN_ENTERPRISE_ACCOUNT_MODEL_GROUP_DOMAIN_OBJECT_HPP_INCLUDED
