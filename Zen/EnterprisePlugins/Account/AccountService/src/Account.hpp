...
public:
    ...
    typedef Zen::Memory::managed_ptr<Model::I_AccountDomainObject>  pAccountDomainObject_type;
	/// @}
...
public:
	...
	/// @name I_Account implemenation
	/// @{
public:
    virtual const AccountId& getAccountId() const;
...
public:
    ...
    public:
        ...
        /// @{
    public:
        boost::uint64_t getRawAccountId() const { return m_nativeAccountId; }
        /// @}
...
public:
             ...
             Account(pAccountDomainObject_type _pDomainObject);
             Account(boost::uint64_t _nativeAccountId);
	virtual ~Account();
	/// @}
