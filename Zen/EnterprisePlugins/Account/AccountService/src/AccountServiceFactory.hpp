...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ENTERPRISE_ACCOUNT_SERVICE_ACCOUNT_SERVICE_FACTORY_HPP_INCLUDED
#define ZEN_ENTERPRISE_ACCOUNT_SERVICE_ACCOUNT_SERVICE_FACTORY_HPP_INCLUDED
...
public:
    ...
    /// @name AccountServiceFactory implementation
    /// @{
private:
...
public:
    ...
    static AccountServiceFactory& getSingleton();
    /// @}
...
#endif // ZEN_ENTERPRISE_ACCOUNT_SERVICE_ACCOUNT_SERVICE_FACTORY_HPP_INCLUDED
