...
{
    throw Zen::Utility::runtime_exception("GameObject::getScriptObject() : Error, not implemented.");
}

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
GameObject::createScriptTypes(pScriptEngine_type _pScriptEngine)
{
    // TODO This is probably not the module we want to add this type to...
    static Zen::Scripting::script_module module(_pScriptEngine, "GameObjectModule");

    module.addType<Zen::Engine::Core::I_GameObject>("GameObject", "Game Object")
        // TODO Add script hooks to implementation of Zen::Engine::Core::I_BaseGameObject,
        // whereever that is :P
        //.addMethod("base", &Zen::Engine::Core::I_GameObject::base)
    ;
