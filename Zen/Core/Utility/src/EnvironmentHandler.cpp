...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
EnvironmentHandler::setCommandLine(int argc, const char *argv[])
{
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
EnvironmentHandler::setEnvironment(const std::string& _name, const std::string& _value)
{
    m_environment[_name] = _value;
}

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
EnvironmentHandler::appendHandler(I_EnvironmentHandler& _handler, bool _before)
{
