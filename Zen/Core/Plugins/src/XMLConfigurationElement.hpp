...
#ifndef ZEN_PLUGINS_XML_CONFIGURATION_ELEMENT_HPP_INCLUDED
#define ZEN_PLUGINS_XML_CONFIGURATION_ELEMENT_HPP_INCLUDED
...
#endif // ZEN_PLUGINS_XML_CONFIGURATION_ELEMENT_HPP_INCLUDED
