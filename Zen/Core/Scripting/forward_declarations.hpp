...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_SCRIPTING_FORWARD_DECLARATIONS_HPP_INCLUDED
#define ZEN_SCRIPTING_FORWARD_DECLARATIONS_HPP_INCLUDED
...
#endif // ZEN_SCRIPTING_FORWARD_DECLARATIONS_HPP_INCLUDED
