...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ARTLIBRARY_CONTRIBUTOR_SERVICE_FACTORY_HPP_INCLUDED
#define ARTLIBRARY_CONTRIBUTOR_SERVICE_FACTORY_HPP_INCLUDED
...
#endif // ARTLIBRARY_CONTRIBUTOR_SERVICE_FACTORY_HPP_INCLUDED
