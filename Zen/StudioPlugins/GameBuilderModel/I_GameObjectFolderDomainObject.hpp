...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef GAMEBUILDER_I_GAMEOBJECTFOLDER_DOMAIN_OBJECT_HPP_INCLUDED
#define GAMEBUILDER_I_GAMEOBJECTFOLDER_DOMAIN_OBJECT_HPP_INCLUDED
...
class GAMEBUILDERMODEL_DLL_LINK I_GameObjectFolderDomainObject
...
public:
    ...
    virtual ElementReference_type getGameObjectFolderId() const = 0;
    ...
    /// to be persisted.
    virtual void setGameObjectFolderId(const boost::any& _value) = 0;
    ...
    /// @{
protected:
             I_GameObjectFolderDomainObject();
    virtual ~I_GameObjectFolderDomainObject();
    /// @}

};  // interface I_GameObjectFolderDomainObject
...
namespace Zen {
namespace Memory {
    /// I_GameObjectFolderDomainObject is a managed by factory
    template<>
    struct is_managed_by_factory<GameBuilder::I_GameObjectFolderDomainObject> : public boost::true_type{};
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
}   // namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // GAMEBUILDER_I_GAMEOBJECTFOLDER_DOMAIN_OBJECT_HPP_INCLUDED
