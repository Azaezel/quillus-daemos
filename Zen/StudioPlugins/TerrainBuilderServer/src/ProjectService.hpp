...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef TERRAINBUILDER_PROJECT_SERVICE_HPP_INCLUDED
#define TERRAINBUILDER_PROJECT_SERVICE_HPP_INCLUDED
...
public:
    ...
    /// @{
public:
    static void destroyProject(wpProject_type _wpProject);
...
#endif // TERRAINBUILDER_PROJECT_SERVICE_HPP_INCLUDED
