...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ARTLIBRARY_ARTASSETDOCUMENT_DOMAIN_OBJECT_HPP_INCLUDED
#define ARTLIBRARY_ARTASSETDOCUMENT_DOMAIN_OBJECT_HPP_INCLUDED
...
class ArtAssetDocumentDomainObject
:	public I_ArtAssetDocumentDomainObject
{
    /// @name Types
    /// @{
public:
...
public:
    ...
    virtual ElementReference_type getArtAssetDocumentId() const;
    ...
    /// to be persisted.
    virtual void setArtAssetDocumentId(const boost::any& _value);
    ...
    /// @{
private:
    pElement_type               m_pArtAssetDocumentId;
    ...
    /// @{
public:
             ArtAssetDocumentDomainObject();
    virtual ~ArtAssetDocumentDomainObject();
    /// @}
...
#endif // ARTLIBRARY_ARTASSETDOCUMENT_DOMAIN_OBJECT_HPP_INCLUDED
