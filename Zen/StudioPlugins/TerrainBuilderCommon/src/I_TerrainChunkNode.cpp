...
#include "../I_TerrainChunkNode.hpp"
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
I_TerrainChunkNode::I_TerrainChunkNode(const std::string& _name)
:   Zen::Studio::Workbench::I_ExplorerNode::UserData(_name)
{
}

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
I_TerrainChunkNode::~I_TerrainChunkNode()
{
}

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
class TerrainChunkNodeType
:   public Zen::Studio::Workbench::generic_explorer_node_type<TerrainChunkNodeType>
{
...
public:
    ...
    /// @{
public:
    TerrainChunkNodeType()
    :   Zen::Studio::Workbench::generic_explorer_node_type<TerrainChunkNodeType>::generic_explorer_node_type("TerrainBuilder::TerrainChunkNode", "./icons/page_green.png")
    {}

    virtual ~TerrainChunkNodeType()
    {}
    /// @}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
static TerrainChunkNodeType sm_type;
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
Zen::Studio::Workbench::I_ExplorerNodeType&
I_TerrainChunkNode::getNodeType()
{
    return sm_type;
}
