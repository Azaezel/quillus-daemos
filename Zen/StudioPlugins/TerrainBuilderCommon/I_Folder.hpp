...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef TERRAINBUILDER_I_FOLDER_HPP_INCLUDED
#define TERRAINBUILDER_I_FOLDER_HPP_INCLUDED
...
class TERRAINBUILDERCOMMON_DLL_LINK I_Folder
...
public:
    ...
    /// @{
public:
    /// Create a new terrain group that is a child of the selected node.
    virtual void newTerrainGroup(Zen::Studio::Workbench::I_ExplorerNode& _selectedNode) = 0;
    /// @}
...
#endif // TERRAINBUILDER_I_FOLDER_HPP_INCLUDED
