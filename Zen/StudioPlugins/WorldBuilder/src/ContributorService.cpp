...
,   m_zoneFolderContributor(*this)
,   m_zoneContributor(*this)
...
{
    // TODO add actions to WorldBuilder::I_Project, I_Folder and I_GameObjectType

    // Zone Folder contributors
    I_ZoneFolder::getNodeType().addContributor(m_zoneFolderContributor);

    // Zone contributors
    I_Zone::getNodeType().addContributor(m_zoneContributor);
    m_zoneContributor.enableActions();
