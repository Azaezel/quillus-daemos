...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef WORLDBUILDER_CONTRIBUTOR_SERVICE_FACTORY_HPP_INCLUDED
#define WORLDBUILDER_CONTRIBUTOR_SERVICE_FACTORY_HPP_INCLUDED
...
#endif // WORLDBUILDER_CONTRIBUTOR_SERVICE_FACTORY_HPP_INCLUDED
