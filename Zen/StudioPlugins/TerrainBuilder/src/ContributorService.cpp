...
,   m_terrainGroupNodeContributor(*this)
,   m_terrainChunkNodeContributor(*this)
{
}
...
ContributorService::enableActions()
{
    ...
    // TerrainGroupNode contributors
    I_TerrainGroupNode::getNodeType().addContributor(m_terrainGroupNodeContributor);
}
