...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef WORLDBUILDER_PROJECT_SERVICE_FACTORY_HPP_INCLUDED
#define WORLDBUILDER_PROJECT_SERVICE_FACTORY_HPP_INCLUDED
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#endif  // WORLDBUILDER_PROJECT_SERVICE_FACTORY_HPP_INCLUDED
