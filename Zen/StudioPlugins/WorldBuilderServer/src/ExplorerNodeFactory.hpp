...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef WORLDBUILDER_EXPLORER_NODE_FACTORY_HPP_INCLUDED
#define WORLDBUILDER_EXPLORER_NODE_FACTORY_HPP_INCLUDED
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#endif  // WORLDBUILDER_EXPLORER_NODE_FACTORY_HPP_INCLUDED
