...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ARTLIBRARY_I_PROJECT_HPP_INCLUDED
#define ARTLIBRARY_I_PROJECT_HPP_INCLUDED
...
/// A project
class ARTLIBRARYCOMMON_DLL_LINK I_Project
...
public:
    ...
    ///                     MUST remain alive for at least as long as the 
    ///                     document (which it will if it keeps a strong 
    ///                     reference to the project).  The listener MUST
    ///                     dereference the subscription before the listener
    ///                     is destroyed.
...
#endif  // ARTLIBRARY_I_PROJECT_HPP_INCLUDED
