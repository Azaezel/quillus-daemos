...
,   m_gameObjectTypeContributor(*this)
{
}
...
{
    // TODO add actions to GameBuilder::I_Project, I_Folder and I_GameObjectType

    // Folder contributors
    I_Folder::getNodeType().addContributor(m_folderContributor);

    // Game object type contributors
    I_GameObjectType::getNodeType().addContributor(m_gameObjectTypeContributor);

    // Game object type document contributors
    I_GameObjectTypeDocument::onRightClickGameObjectTypeLabel
        .connect(boost::bind(&GameObjectTypeContributor::getActions, 
                                m_gameObjectTypeContributor, _1));
}
