...
PersistenceProperty::getType() const
{
    return ENUM_TYPE;
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
PersistenceProperty::getEnums(I_EnumVisitor& _visitor)
{
    _visitor.visit("<inherit from parent>");
    _visitor.visit("Static");
    _visitor.visit("Dynamic");
    _visitor.visit("Persistent");
    _visitor.visit("Transaction");
}
