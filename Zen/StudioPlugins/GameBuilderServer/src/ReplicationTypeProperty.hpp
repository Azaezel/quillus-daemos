...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef GAME_BUILDER_REPLICATION_TYPE_PROPERTY_HPP_INCLUDED
#define GAME_BUILDER_REPLICATION_TYPE_PROPERTY_HPP_INCLUDED
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#endif // GAME_BUILDER_REPLICATION_TYPE_PROPERTY_HPP_INCLUDED
