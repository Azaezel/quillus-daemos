...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef GAMEBUILDER_DELETECHILDNODE_RESPONSE_HPP_INCLUDED
#define GAMEBUILDER_DELETECHILDNODE_RESPONSE_HPP_INCLUDED
...
public:
    ...
    /// @{
protected:
    friend class I_DeleteChildNodeResponse;
...
#endif // GAMEBUILDER_DELETECHILDNODE_RESPONSE_HPP_INCLUDED
