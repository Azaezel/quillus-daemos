...
:   Request(DeleteChildNodeRequest::createMessageHeader(getNewMessageId()), _pSourceEndpoint, _pDestinationEndpoint)        
{
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
DeleteChildNodeRequest::pMessageType_type
DeleteChildNodeRequest::getStaticMessageType()
{
    return sm_pType;
}
