...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
I_Zone::I_Zone(const std::string& _name)
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
class ZoneType
:   public Zen::Studio::Workbench::generic_explorer_node_type<ZoneType>
{
...
public:
    ZoneType()
    :   Zen::Studio::Workbench::generic_explorer_node_type<ZoneType>::generic_explorer_node_type("WorldBuilder::Zone", "./icons/page_green.png")
    {
    }
