...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef TERRAINBUILDER_TERRAINFOLDER_DOMAIN_OBJECT_HPP_INCLUDED
#define TERRAINBUILDER_TERRAINFOLDER_DOMAIN_OBJECT_HPP_INCLUDED

#include "../I_TerrainFolderDomainObject.hpp"
...
class TerrainFolderDomainObject
:	public I_TerrainFolderDomainObject
{
    /// @name Types
    /// @{
public:
...
public:
    ...
    virtual ElementReference_type getTerrainFolderId() const;
    ...
    /// to be persisted.
    virtual void setTerrainFolderId(const boost::any& _value);
    ...
    /// @{
private:
    pElement_type               m_pTerrainFolderId;
    ...
    /// @{
public:
             TerrainFolderDomainObject();
    virtual ~TerrainFolderDomainObject();
    /// @}
...
#endif // TERRAINBUILDER_TERRAINFOLDER_DOMAIN_OBJECT_HPP_INCLUDED
