...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef TERRAINBUILDER_TERRAINCHUNK_DOMAIN_OBJECT_HPP_INCLUDED
#define TERRAINBUILDER_TERRAINCHUNK_DOMAIN_OBJECT_HPP_INCLUDED

#include "../I_TerrainChunkDomainObject.hpp"
...
class TerrainChunkDomainObject
:	public I_TerrainChunkDomainObject
{
    /// @name Types
    /// @{
public:
...
public:
    ...
    virtual ElementReference_type getTerrainChunkId() const;
    ...
    /// to be persisted.
    virtual void setTerrainChunkId(const boost::any& _value);
    ...
    /// @{
private:
    pElement_type               m_pTerrainChunkId;
    ...
    /// @{
public:
             TerrainChunkDomainObject();
    virtual ~TerrainChunkDomainObject();
    /// @}
...
#endif // TERRAINBUILDER_TERRAINCHUNK_DOMAIN_OBJECT_HPP_INCLUDED
