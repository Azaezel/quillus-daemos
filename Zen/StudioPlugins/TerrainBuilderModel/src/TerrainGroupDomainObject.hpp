...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef TERRAINBUILDER_TERRAINGROUP_DOMAIN_OBJECT_HPP_INCLUDED
#define TERRAINBUILDER_TERRAINGROUP_DOMAIN_OBJECT_HPP_INCLUDED

#include "../I_TerrainGroupDomainObject.hpp"
...
class TerrainGroupDomainObject
:	public I_TerrainGroupDomainObject
{
    /// @name Types
    /// @{
public:
...
public:
    ...
    virtual ElementReference_type getTerrainGroupId() const;
    ...
    /// to be persisted.
    virtual void setTerrainGroupId(const boost::any& _value);
    ...
    /// @{
private:
    pElement_type               m_pTerrainGroupId;
    ...
    /// @{
public:
             TerrainGroupDomainObject();
    virtual ~TerrainGroupDomainObject();
    /// @}
...
#endif // TERRAINBUILDER_TERRAINGROUP_DOMAIN_OBJECT_HPP_INCLUDED
