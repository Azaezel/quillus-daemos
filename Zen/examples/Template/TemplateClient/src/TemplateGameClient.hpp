...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef INDIEZEN_TEMPLATE_TEMPLATE_GAME_CLIENT_HPP_INCLUDED
#define INDIEZEN_TEMPLATE_TEMPLATE_GAME_CLIENT_HPP_INCLUDED
...
public:
    ...
    /// @name TemplateGameClient implementation
    /// @{
public:
...
public:
    ...
    /// @{
public:
             TemplateGameClient(WindowHandle_type _pParent);
    virtual ~TemplateGameClient();
    /// @}
...
#endif // INDIEZEN_TEMPLATE_TEMPLATE_GAME_CLIENT_HPP_INCLUDED
