...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_CLIENT_ZERO_TORQUE_BEHAVIOR_HPP_INCLUDED
#define ZEN_CLIENT_ZERO_TORQUE_BEHAVIOR_HPP_INCLUDED
...
#endif // ZEN_CLIENT_ZERO_TORQUE_BEHAVIOR_HPP_INCLUDED
