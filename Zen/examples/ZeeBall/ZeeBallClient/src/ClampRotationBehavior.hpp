...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_CLIENT_CLAMMP_ROTATION_BEHAVIOR_HPP_INCLUDED
#define ZEN_CLIENT_CLAMMP_ROTATION_BEHAVIOR_HPP_INCLUDED
...
#endif // ZEN_CLIENT_CLAMMP_ROTATION_BEHAVIOR_HPP_INCLUDED
