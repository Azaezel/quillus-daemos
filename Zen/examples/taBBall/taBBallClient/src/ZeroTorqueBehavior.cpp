...
namespace Pong {
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
ZeroTorqueBehavior::ZeroTorqueBehavior()
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
bool
ZeroTorqueBehavior::handlePhysicsForce(Engine::Core::I_BaseGameObject& _gameObject, Engine::Physics::I_PhysicsShape::I_ApplyForcesEventData& _eventData)
{
    Math::Vector3 torque;
    ...
    Math::Matrix4 newOrientation(Math::Matrix4::INIT_IDENTITY);
    ...
    Math::Vector3 stopped(0.0f, 0.0f, 0.0f);
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
ZeroTorqueBehavior::setGravity(const Math::Vector3& _vector)
{
    m_gravity = _vector;
}
