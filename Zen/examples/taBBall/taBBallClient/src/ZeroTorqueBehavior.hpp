...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_PONG_CLIENT_ZERO_TORQUE_BEHAVIOR_HPP_INCLUDED
#define ZEN_PONG_CLIENT_ZERO_TORQUE_BEHAVIOR_HPP_INCLUDED
...
public:
    ...
    /// @name ZeroTorqueBehavior implementation
    /// @{
public:
...
#endif // ZEN_PONG_CLIENT_ZERO_TORQUE_BEHAVIOR_HPP_INCLUDED
