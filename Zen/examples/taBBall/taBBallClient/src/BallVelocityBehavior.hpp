...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_PONG_CLIENT_BALL_VELOCITY_BEHAVIOR_HPP_INCLUDED
#define ZEN_PONG_CLIENT_BALL_VELOCITY_BEHAVIOR_HPP_INCLUDED
...
public:
    ...
    /// @{
public:
    void setSpeed(Math::Real _speed);
    /// @}
...
#endif // ZEN_PONG_CLIENT_BALL_VELOCITY_BEHAVIOR_HPP_INCLUDED
