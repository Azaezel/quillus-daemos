...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ZMYSQL_DATABASE_SERVICE_FACTORY_HPP_INCLUDED
#define ZEN_ZMYSQL_DATABASE_SERVICE_FACTORY_HPP_INCLUDED
...
#endif // ZEN_ZMYSQL_DATABASE_SERVICE_FACTORY_HPP_INCLUDED
