...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ZTERRAIN_ZTERRAIN_PLUGIN_HPP_INCLUDED
#define ZEN_ZTERRAIN_ZTERRAIN_PLUGIN_HPP_INCLUDED
...
#endif // ZEN_ZTERRAIN_ZTERRAIN_PLUGIN_HPP_INCLUDED
