...
#include "ZCloudPlugin.hpp"

#include "CloudServiceFactory.hpp"
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
ZCloudPlugin::initExtensionPoints()
{
}

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
ZCloudPlugin::initExtensions()
{
...
ZCloudPlugin::getClassFactory(const Plugins::I_ConfigurationElement& _config)
{
    ...
    if (extensionPoint == "Zen::Engine::Cloud::CloudService")
    {
        return &CloudServiceFactory::getSingleton();
    }
    else if (extensionPoint == "Zen::Engine::Resource::ResourceService")
    {
        return &ResourceServiceFactory::getSingleton();
    }
