...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ZSQLITE_DATABASE_ROW_HPP_INCLUDED
#define ZEN_ZSQLITE_DATABASE_ROW_HPP_INCLUDED
...
public:
    ...
    /// @{
public:
             DatabaseRow(sqlite3_stmt* _pResult);
    virtual ~DatabaseRow();
    /// @}
...
#endif // ZEN_ZSQLITE_DATABASE_ROW_HPP_INCLUDED
