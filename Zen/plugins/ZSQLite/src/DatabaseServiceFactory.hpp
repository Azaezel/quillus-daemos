...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ZSQLITE_DATABASE_SERVICE_FACTORY_HPP_INCLUDED
#define ZEN_ZSQLITE_DATABASE_SERVICE_FACTORY_HPP_INCLUDED
...
#endif // ZEN_ZSQLITE_DATABASE_SERVICE_FACTORY_HPP_INCLUDED
