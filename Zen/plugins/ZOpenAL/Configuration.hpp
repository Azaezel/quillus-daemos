...
#    ifdef  ZOPENAL_EXPORTS
#        define ZOPENAL_DLL_LINK __declspec(dllexport)
#    else
#        define ZOPENAL_DLL_LINK __declspec(dllimport)
#    endif
#endif  // _MSC_VER
...
#        ifdef  ZOPENAL_EXPORTS
#            define ZOPENAL_DLL_LINK __attribute__ ((visibility ("default")))
#        else
#            define ZOPENAL_DLL_LINK __attribute__ ((visibility ("hidden")))
#        endif
#    else
#        ifdef  ZOPENAL_EXPORTS
#            define ZOPENAL_DLL_LINK // __declspec(dllexport)
