...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ZOPENAL_SOUND_SERVICE_FACTORY_HPP_INCLUDED
#define ZEN_ZOPENAL_SOUND_SERVICE_FACTORY_HPP_INCLUDED
...
:   public Engine::Sound::I_SoundServiceFactory
{
...
#endif // ZEN_ZOPENAL_SOUND_SERVICE_FACTORY_HPP_INCLUDED
