...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ZNEWTON_ZNEWTON_PLUGIN_HPP_INCLUDED
#define ZEN_ZNEWTON_ZNEWTON_PLUGIN_HPP_INCLUDED
...
#endif // ZEN_ZNEWTON_ZNEWTON_PLUGIN_HPP_INCLUDED
