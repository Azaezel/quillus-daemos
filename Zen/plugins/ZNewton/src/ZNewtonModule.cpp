...
#include "../ZNewtonModule.hpp"

#include "ZNewtonPlugin.hpp"
...
:   public Plugins::I_Module
{
    ...
    /// @{
public:
    typedef boost::shared_ptr<ZNewtonPlugin>     plugin_ptr_type;
    /// @}
...
public:
             ZNewtonModule();
    virtual ~ZNewtonModule();
    /// @}

    /// @name Implementation
    /// @{
public:
    static ZNewtonModule& instance();
    /// @}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
ZNewtonModule::ZNewtonModule()
{
    // TODO: Register the plugins
    m_pPlugin = plugin_ptr_type(new ZNewtonPlugin);
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
static ZNewtonModule* pModule = NULL;

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
ZNewtonModule& 
ZNewtonModule::instance()
{
    // TODO: Guard
    if (pModule == NULL)
    {
        pModule = new ZNewtonModule();
    }
...
ZNewtonModule::getPlugin(const plugin_name_type& _PluginName)
{
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void 
ZNewtonModule::destroyPlugin(Plugins::I_Module::plugin_ptr_type _pPlugin)
{
    // TODO delete?
}
...
getModule()
{
    return Zen::ZNewton::ZNewtonModule::instance();
}
