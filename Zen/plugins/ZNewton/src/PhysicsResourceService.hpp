...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ZNEWTON_PHYSICS_RESOURCE_SERVICE_HPP_INCLUDED
#define ZEN_ZNEWTON_PHYSICS_RESOURCE_SERVICE_HPP_INCLUDED
...
#endif // ZEN_ZNEWTON_PHYSICS_RESOURCE_SERVICE_HPP_INCLUDED
