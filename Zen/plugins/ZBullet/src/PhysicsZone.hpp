...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ZBULLET_PHYSICS_ZONE_HPP_INCLUDED
#define ZEN_ZBULLET_PHYSICS_ZONE_HPP_INCLUDED
// Reference Note: http://www.bulletphysics.com/Bullet/BulletFull/classbtDiscreteDynamicsWorld.html
...
public:
    ...
    /// @{
    public:
        virtual btDiscreteDynamicsWorld* getZonePtr();
        virtual void setZonePtr(btDiscreteDynamicsWorld* _pZone);
    /// @}
...
public:
	...
	{
		RayResultCallback(const btVector3&	_rayFromWorld,const btVector3&	_rayToWorld)
		:m_rayFromWorld(_rayFromWorld),
		m_rayToWorld(_rayToWorld)
		{
		}
		...
		virtual	btScalar	addSingleResult(btCollisionWorld::LocalRayResult& _rayResult,bool _normalInWorldSpace);
	};
    ...
    /// @{
private:
    btDiscreteDynamicsWorld*            m_pZone;
...
#endif // ZEN_ZBULLET_PHYSICS_ZONE_HPP_INCLUDED
