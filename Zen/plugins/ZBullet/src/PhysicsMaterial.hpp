...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ZBULLET_PHYSICS_MATERIAL_HPP_INCLUDED
#define ZEN_ZBULLET_PHYSICS_MATERIAL_HPP_INCLUDED
...
private:
    ...
    btDiscreteDynamicsWorld*         m_pNewtonZone;
...
#endif // ZEN_ZBULLET_PHYSICS_MATERIAL_HPP_INCLUDED
