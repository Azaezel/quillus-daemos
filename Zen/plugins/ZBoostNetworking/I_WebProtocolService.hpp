...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ENTERPRISE_APPSERVER_I_HTTP_SERVICE_HPP_INCLUDED
#define ZEN_ENTERPRISE_APPSERVER_I_HTTP_SERVICE_HPP_INCLUDED
...
class ZBOOSTNETWORKING_DLL_LINK I_WebProtocolService
...
public:
    ...
    /// @{
protected:
             I_WebProtocolService();
    virtual ~I_WebProtocolService();
    /// @}

};  // interface I_WebProtocolService
...
#endif // ZEN_ENTERPRISE_APPSERVER_I_HTTP_SERVICE_HPP_INCLUDED
