...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ENTERPRISE_APPSERVER_HTTP_PROTOCOL_SERVICE_HPP_INCLUDED
#define ZEN_ENTERPRISE_APPSERVER_HTTP_PROTOCOL_SERVICE_HPP_INCLUDED

#include "../I_WebProtocolService.hpp"
...
class HyperTextTransportProtocolService
:   public I_WebProtocolService
...
public:
    ...
    /// @name I_HTTPService implementation
    /// @{
public:
...
public:
    ...
    /// @name HyperTextTransportProtocolService implementation
    /// @{
public:
...
protected:
    ...
    explicit HyperTextTransportProtocolService(I_ApplicationServer& _server);
    virtual ~HyperTextTransportProtocolService();
    /// @}
...
private:
    ...
    /// Request handler
    HTTP::RequestHandler*               m_pRequestHandler;
    ...
    boost::shared_ptr<HTTP::Connection> m_pNewConnection;
...
#endif // ZEN_ENTERPRISE_APPSERVER_HTTP_PROTOCOL_SERVICE_HPP_INCLUDED
