...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ENTERPRISE_APPSERVER_XML_REQUEST_PARSER_HPP_INCLUDED
#define ZEN_ENTERPRISE_APPSERVER_XML_REQUEST_PARSER_HPP_INCLUDED
...
#endif // ZEN_ENTERPRISE_APPSERVER_XML_REQUEST_PARSER_HPP_INCLUDED
