...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ENTERPRISE_APPSERVER_XML_MESSAGE_HPP_INCLUDED
#define ZEN_ENTERPRISE_APPSERVER_XML_MESSAGE_HPP_INCLUDED
...
public:
    ...
    /// @{
public:
             Message(pEndpoint_type _pSourceEndpoint, pEndpoint_type _pDestinationEndpoint, pResourceLocation_type _pResourceLocation);
    virtual ~Message();
    /// @}
...
#endif // ZEN_ENTERPRISE_APPSERVER_XML_MESSAGE_HPP_INCLUDED
