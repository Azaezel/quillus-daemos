...
{
    /// Delete the Response
    Reply* pResponse = dynamic_cast<Reply*>(_wpResponse.get());
    ...
    {
        throw Zen::Utility::runtime_exception("XML::I_XMLResponse::destroyResponse() : Invalid type.");
    }
}
