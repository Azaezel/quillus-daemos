...
{
    return m_bodyLength + HEADER_LENGTH;
}

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
boost::uint32_t
MessageBuffer::getBodyLength()
{
    return m_bodyLength;
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
MessageBuffer::setBodyLength(boost::uint32_t _length)
{
    m_bodyLength = _length;
}

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
/// Reformat an integer to the big-endian network format
boost::uint32_t
native_to_big(boost::uint32_t x)
{
    boost::uint32_t  temp;
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
/// Restore an integer from the big-endian network format
boost::uint32_t
big_to_native(boost::uint32_t x)
{
