...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ENTERPRISE_APPSERVER_HTTP_REQUEST_HANDLER_HPP_INCLUDED
#define ZEN_ENTERPRISE_APPSERVER_HTTP_REQUEST_HANDLER_HPP_INCLUDED
...
#endif // ZEN_ENTERPRISE_APPSERVER_HTTP_REQUEST_HANDLER_HPP_INCLUDED
