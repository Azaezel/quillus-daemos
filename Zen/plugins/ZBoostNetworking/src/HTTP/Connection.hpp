...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ENTERPRISE_APPSERVER_HTTP_CONNECTION_HPP_INCLUDED
#define ZEN_ENTERPRISE_APPSERVER_HTTP_CONNECTION_HPP_INCLUDED
...
public:
    ...
    HyperTextTransportProtocolService& getProtocolService();
...
protected:
    ...
    /// @{
public:
    explicit Connection(boost::asio::io_service& _ioService, HyperTextTransportProtocolService& _protocolService);
    virtual ~Connection();
...
#endif // ZEN_ENTERPRISE_APPSERVER_HTTP_CONNECTION_HPP_INCLUDED
