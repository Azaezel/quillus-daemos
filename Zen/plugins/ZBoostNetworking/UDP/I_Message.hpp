...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ENTERPRISE_APPSERVER_UDP_I_MESSAGE_HPP_INCLUDED
#define ZEN_ENTERPRISE_APPSERVER_UDP_I_MESSAGE_HPP_INCLUDED
...
class ZBOOSTNETWORKING_DLL_LINK I_Message
:   public virtual Zen::Enterprise::AppServer::I_Message
{
    /// @name UDP::I_Message interface
    /// @{
public:
...
#endif // ZEN_ENTERPRISE_APPSERVER_UDP_I_MESSAGE_HPP_INCLUDED
