...
#include "SceneServiceFactory.hpp"
...
namespace ZOgre {
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
SceneServiceFactory::SceneServiceFactory()
{
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
static SceneServiceFactory sm_SceneServiceFactory;

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
SceneServiceFactory&
SceneServiceFactory::instance()
{
    return sm_SceneServiceFactory;
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
SceneServiceFactory::destroy(wpSceneService_type _pService)
{
    /// Fire the service's onDestroyEvent.
    _pService->onDestroyEvent(_pService);

    /// Delete the service
    SceneService* pService = dynamic_cast<SceneService*>(_pService.get());
