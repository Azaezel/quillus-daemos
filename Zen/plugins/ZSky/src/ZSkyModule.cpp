...
#include "../ZSkyModule.hpp"

#include "ZSkyPlugin.hpp"
...
:   public Plugins::I_Module
{
    ...
    /// @{
public:
    typedef boost::shared_ptr<ZSkyPlugin>     plugin_ptr_type;
    /// @}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
ZSkyModule::ZSkyModule()
{
    // TODO: Register the plugins
    m_pPlugin = plugin_ptr_type(new ZSkyPlugin);
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
static ZSkyModule* pModule = NULL;
...
ZSkyModule::getPlugin(const plugin_name_type& _PluginName)
{
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void 
ZSkyModule::destroyPlugin(Plugins::I_Module::plugin_ptr_type _pPlugin)
{
    // TODO delete?
}
...
getModule()
{
    return Zen::ZSky::ZSkyModule::instance();
}
