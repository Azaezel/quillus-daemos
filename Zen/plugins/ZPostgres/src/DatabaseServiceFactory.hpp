...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef INDIEZEN_ZPOSTGRES_DATABASE_SERVICE_FACTORY_HPP_INCLUDED
#define INDIEZEN_ZPOSTGRES_DATABASE_SERVICE_FACTORY_HPP_INCLUDED
...
#endif // INDIEZEN_ZPOSTGRES_DATABASE_SERVICE_FACTORY_HPP_INCLUDED
