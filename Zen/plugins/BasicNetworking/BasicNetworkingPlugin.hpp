...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef INDIEZEN_BASIC_NETWORKING_BASIC_NETWORKING_PLUGIN_HPP_INCLUDED
#define INDIEZEN_BASIC_NETWORKING_BASIC_NETWORKING_PLUGIN_HPP_INCLUDED
...
public:
    ...
    /// @{
public:
             BasicNetworkingPlugin();
    virtual ~BasicNetworkingPlugin();
    /// @}
...
#endif // INDIEZEN_BASIC_NETWORKING_BASIC_NETWORKING_PLUGIN_HPP_INCLUDED
