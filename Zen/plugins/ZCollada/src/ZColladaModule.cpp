...
class ZColladaModule
:   public Plugins::I_Module
{
    /// @name Types
    /// @{
public:
    typedef boost::shared_ptr<ZColladaPlugin>     plugin_ptr_type;
    /// @}
...
public:
             ZColladaModule();
    virtual ~ZColladaModule();
    /// @}

    /// @name Implementation
    /// @}
public:
    static ZColladaModule& getSingleton();
    /// @}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
ZColladaModule::ZColladaModule()
{
    // TODO: Register the plugins
    m_pPlugin = plugin_ptr_type(new ZColladaPlugin);
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
static ZColladaModule* pModule = NULL;

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
ZColladaModule& 
ZColladaModule::getSingleton()
{
    // TODO: Guard
    if (pModule == NULL)
    {
        pModule = new ZColladaModule();
    }
...
ZColladaModule::getPlugin(const plugin_name_type& _PluginName)
{
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void 
ZColladaModule::destroyPlugin(Plugins::I_Module::plugin_ptr_type _pPlugin)
{
    // TODO delete?
}
...
getModule()
{
    return IndieZen::ZCollada::ZColladaModule::getSingleton();
}
