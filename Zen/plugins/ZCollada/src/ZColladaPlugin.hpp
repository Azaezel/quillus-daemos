...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef INDIEZEN_ZCOLLADA_ZCOLLADA_PLUGIN_HPP_INCLUDED
#define INDIEZEN_ZCOLLADA_ZCOLLADA_PLUGIN_HPP_INCLUDED
...
#endif // INDIEZEN_ZCOLLADA_ZCOLLADA_PLUGIN_HPP_INCLUDED
