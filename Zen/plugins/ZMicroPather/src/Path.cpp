...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void 
Path::destroy(wpNodeIterator_type _pType)
{
    NodeIterator* pNodeIterator =
        dynamic_cast<NodeIterator*>(_pType.get());
    ...
    {
        throw Zen::Utility::runtime_exception("Path::destroy() : Invalid type.");
    }
}
