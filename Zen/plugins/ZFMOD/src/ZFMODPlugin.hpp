...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ZFMOD_ZFMOD_PLUGIN_HPP_INCLUDED
#define ZEN_ZFMOD_ZFMOD_PLUGIN_HPP_INCLUDED
...
#endif // ZEN_ZFMOD_ZFMOD_PLUGIN_HPP_INCLUDED
