...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ZODE_PHYSICS_JOINT_HPP_INCLUDED
#define ZEN_ZODE_PHYSICS_JOINT_HPP_INCLUDED
...
,   public Memory::managed_self_ref<Zen::Engine::Physics::I_PhysicsJoint>
{
    ...
    /// @{
public:
    virtual void attachActor(pPhysicsActor_type _pActor);
...
#endif // ZEN_ZODE_PHYSICS_JOINT_HPP_INCLUDED
