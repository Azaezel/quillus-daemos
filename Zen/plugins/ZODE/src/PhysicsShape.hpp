...
public:
    ...
    public:
        ...
        virtual void setContactSoftness(Math::Real _softness)
        {
            NewtonMaterialSetContactSoftness(m_pMaterial, _softness);
        }

        virtual void setContactElasticity(Math::Real _restitution)
        {
