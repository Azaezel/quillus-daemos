...
:   public Plugins::I_Module
{
    ...
    /// @{
public:
    typedef boost::shared_ptr<ZODEPlugin>     plugin_ptr_type;
    /// @}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
ZODEModule::ZODEModule()
{
    // TODO: Register the plugins
    m_pPlugin = plugin_ptr_type(new ZODEPlugin);
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
static ZODEModule* pModule = NULL;
...
ZODEModule::getPlugin(const plugin_name_type& _PluginName)
{
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void 
ZODEModule::destroyPlugin(Plugins::I_Module::plugin_ptr_type _pPlugin)
{
    // TODO delete?
}
...
getModule()
{
    return Zen::ZODE::ZODEModule::instance();
}
