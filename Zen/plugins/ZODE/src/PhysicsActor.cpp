...
{
    throw Utility::runtime_exception("PhysicsActor::getPhysicsZone(): Error, not implemented.");
}
...
{
    throw Utility::runtime_exception("PhysicsActor::setMass(): Error, not implemented.");
}
...
{
    throw Utility::runtime_exception("PhysicsActor::setPosition(): Error, not implemented.");
}
