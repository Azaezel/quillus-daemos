...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ZPHYSX_ZPHYSX_PLUGIN_HPP_INCLUDED
#define ZEN_ZPHYSX_ZPHYSX_PLUGIN_HPP_INCLUDED
...
#endif // ZEN_ZPHYSX_ZPHYSX_PLUGIN_HPP_INCLUDED
