...
:   public Plugins::I_Module
{
    ...
    /// @{
public:
    typedef boost::shared_ptr<ZPhysXPlugin>     plugin_ptr_type;
    /// @}
...
public:
             ZPhysXModule();
    virtual ~ZPhysXModule();
    /// @}

    /// @name Implementation
    /// @{
public:
    static ZPhysXModule& instance();
    /// @}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
ZPhysXModule::ZPhysXModule()
{
    // TODO: Register the plugins
    m_pPlugin = plugin_ptr_type(new ZPhysXPlugin);
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
static ZPhysXModule* pModule = NULL;

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
ZPhysXModule& 
ZPhysXModule::instance()
{
    // TODO: Guard
    if (pModule == NULL)
    {
        pModule = new ZPhysXModule();
    }
...
ZPhysXModule::getPlugin(const plugin_name_type& _PluginName)
{
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void 
ZPhysXModule::destroyPlugin(Plugins::I_Module::plugin_ptr_type _pPlugin)
{
    // TODO delete?
}
...
getModule()
{
    return Zen::ZPhysX::ZPhysXModule::instance();
}
