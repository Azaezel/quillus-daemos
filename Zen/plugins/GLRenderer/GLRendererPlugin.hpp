...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef INDIEZEN_RENDERER_GL_RENDERER_PLUGIN_HPP_INCLUDED
#define INDIEZEN_RENDERER_GL_RENDERER_PLUGIN_HPP_INCLUDED
...
#endif // INDIEZEN_RENDERER_GL_RENDERER_PLUGIN_HPP_INCLUDED
