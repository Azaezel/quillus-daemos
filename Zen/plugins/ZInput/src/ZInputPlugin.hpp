...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ZINPUT_ZINPUT_PLUGIN_HPP_INCLUDED
#define ZEN_ZINPUT_ZINPUT_PLUGIN_HPP_INCLUDED
...
#endif // ZEN_ZINPUT_ZINPUT_PLUGIN_HPP_INCLUDED
