...
public:
    ...
    /// @name I_KeyEvent implementation
    /// @{
public:
    virtual Engine::Input::KeyCode_enum getKeyCode();
    virtual char getChar();
    virtual bool getPressedState() const;
    virtual const Engine::Input::I_KeyState& getKeyState() const;
...
#endif // ZEN_ZINPUT_KEY_EVENT_HPP_INCLUDED
