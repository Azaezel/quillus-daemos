...
#include "ZOgreTerrainPlugin.hpp"
...
ZOgreTerrainPlugin::ZOgreTerrainPlugin()
{
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
ZOgreTerrainPlugin::initExtensionPoints()
{
}

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
ZOgreTerrainPlugin::initExtensions()
{
...
ZOgreTerrainPlugin::getClassFactory(const Plugins::I_ConfigurationElement& _config)
{
    ...
    if (extensionPoint == "Zen::Engine::World::TerrainService")
    {
        return &TerrainServiceFactory::getSingleton();
    }
