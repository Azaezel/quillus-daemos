...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ENGINE_MOVEMANAGER_MOVE_MANAGER_HPP_INCLUDED
#define ZEN_ENGINE_MOVEMANAGER_MOVE_MANAGER_HPP_INCLUDED
...
public:
    ...
    virtual void registerDefaultScriptEngine(Scripting::I_ScriptEngine* _pEngine);

    /// Get the default Rendering script module.
    virtual Scripting::I_ScriptModule* getDefaultScriptModule();
    /// @}
...
#endif // ZEN_ENGINE_MOVEMANAGER_MOVE_MANAGER_HPP_INCLUDED
