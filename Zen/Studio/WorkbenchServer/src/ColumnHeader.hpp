...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZENSTUDIO_WORKBENCH_COLUMN_HEADER_HPP_INCLUDED
#define ZENSTUDIO_WORKBENCH_COLUMN_HEADER_HPP_INCLUDED
...
public:
    ...
    /// @name ColumnHeader implementation
    /// @{
public:
    ...
    /// @{
public:
    ColumnHeader(boost::uint64_t _spreadSheetDocumentId, const std::string& _label);
    /// @}
...
private:
    ...
    std::string         m_label;
    boost::uint64_t     m_spreadSheetColumnId;
    int                 m_columnNumber;
    bool                m_isDirty;
    /// @}
...
#endif // ZENSTUDIO_WORKBENCH_COLUMN_HEADER_HPP_INCLUDED
