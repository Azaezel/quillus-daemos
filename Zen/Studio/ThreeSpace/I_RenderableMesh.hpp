...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef INDIEZEN_THREESPACE_I_RENDERABLE_MESH_HPP_INCLUDED
#define INDIEZEN_THREESPACE_I_RENDERABLE_MESH_HPP_INCLUDED
...
/// @since 1.0
class THREESPACE_DLL_LINK I_RenderableMesh
:   public I_Mesh
{
    /// @name Types
    /// @{
public:
    ...
    /// @name I_RenderableMesh interface
    /// @{ 
public:
...
protected:
             I_RenderableMesh();
    virtual ~I_RenderableMesh();
    /// @}

};  // interface I_RenderableMesh
...
#endif // INDIEZEN_THREESPACE_I_RENDERABLE_MESH_HPP_INCLUDED
