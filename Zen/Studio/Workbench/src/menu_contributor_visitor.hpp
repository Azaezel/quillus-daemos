...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZENSTUDIO_WORKBENCH_MENU_CONTRIBUTOR_VISITOR_HPP_INCLUDED
#define ZENSTUDIO_WORKBENCH_MENU_CONTRIBUTOR_VISITOR_HPP_INCLUDED

// This template is intended to replace multiple copy / paste 
// implementations of MenuContributorVisitor

#if 0 // not fully implemented, possibly not needed

#include "contributor_visitor.hpp"
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
;
/// Menu Contributor Visitor helper template.
/// This template implements a menu contributor visitor that can be used for 
/// most contributor (all?) types.
/// The purpose of this visitor is to construct an appropriate menu.
template <class Contributee_type>
class menu_contributor_visitor
:   public contributor_visitor<Contributee_type>
{
    /// @name Types
    /// @{
public:
...
#endif // ZENSTUDIO_WORKBENCH_MENU_CONTRIBUTOR_VISITOR_HPP_INCLUDED
