...
namespace Workbench {
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
BEGIN_EVENT_TABLE(FileWizardDialog, wxDialog)
    EVT_CLOSE(FileWizardDialog::onClose)
    EVT_BUTTON(wxID_BACKWARD, FileWizardDialog::onBack)
    EVT_BUTTON(wxID_FORWARD, FileWizardDialog::onNext)
    EVT_BUTTON(wxID_OK, FileWizardDialog::onFinish)
    EVT_BUTTON(wxID_CANCEL, FileWizardDialog::onCancel)
    EVT_TREE_SEL_CHANGED(ID_WIZARD_TREE, FileWizardDialog::onWizardSelected)
    EVT_TREE_KEY_DOWN(ID_WIZARD_TREE, FileWizardDialog::onKeyDown)
END_EVENT_TABLE()

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
FileWizardDialog::FileWizardDialog(StudioTopFrame* _pParent)
:   wxDialog(_pParent, -1, wxT("File Wizard"), wxDefaultPosition, wxDefaultSize,
             wxDEFAULT_DIALOG_STYLE | wxRESIZE_BORDER
             )
,   m_pParent(_pParent)
,   m_pDocumentType(NULL)
{
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
FileWizardDialog::~FileWizardDialog()
{
}

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
FileWizardDialog::startWizard()
{
    m_topSizer->Show(m_nextPanel, false, true);
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
FileWizardDialog::initFirstPanel()
{
    ...
    wxStaticText* st1 = new wxStaticText(m_firstPanel, wxID_ANY, wxT("File Type:"));
    ...
    struct DocumentTypeVisitor : I_ProjectType::I_DocumentTypeVisitor
    {
        ...
        void visit(I_DocumentType& _documentType)
        {
            m_pTreeControl->AppendItem(m_parent, std2wx(_documentType.getName()), -1, -1, new DocumentTypeTreeItem(_documentType));
        }
        ...
        DocumentTypeVisitor(wxTreeCtrl* _pTreeControl, wxTreeItemId _parent)
            : m_pTreeControl(_pTreeControl), m_parent(_parent) {}
    ...
    struct ProjectTypeVisitor : I_ProjectTypes::I_ProjectTypeVisitor
    {
        ...
        void visit(const I_ProjectType& _projectType)
        {
            ...
            DocumentTypeVisitor visitor(m_pTreeControl, parent);
            _projectType.getDocumentTypes(visitor);
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
FileWizardDialog::onClose(wxCloseEvent& _event)
{
    EndDialog(0);
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
FileWizardDialog::onBack(wxCommandEvent& _event)
{
    EndDialog(0);
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
FileWizardDialog::onNext(wxCommandEvent& _event)
{
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
FileWizardDialog::onFinish(wxCommandEvent& _event)
{
    EndDialog(0);
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
FileWizardDialog::onCancel(wxCommandEvent& _event)
{
    EndDialog(0);
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
FileWizardDialog::onWizardSelected(wxTreeEvent& _event)
{
    wxTreeItemData* pItem = m_treeControl->GetItemData(_event.GetItem());

    m_pDocumentType = dynamic_cast<DocumentTypeTreeItem*>(pItem);
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
FileWizardDialog::onKeyDown(wxTreeEvent& _event)
{
