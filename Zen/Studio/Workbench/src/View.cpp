...
namespace Workbench {
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
View::View(wxWindow* _pParent, Workbench* _pWorkbench, pViewable_type _pViewable, const int _instance)
:   wxPanel(_pParent, 1)
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
I_Viewable*
View::getViewable() const
{
    return m_pViewable.get();
}
...
{
    // TODO Implement
    // TR - I don't remember what this was intended to do.
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
View::setPage(wxAuiNotebook* _pNotebook, wxWindow* _pPage)
{
    m_pNotebook = _pNotebook;
    m_pPage     = _pPage;
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
I_Document*
View::getDocument() const
{
    return dynamic_cast<I_Document*>(m_pViewable.get());
}
