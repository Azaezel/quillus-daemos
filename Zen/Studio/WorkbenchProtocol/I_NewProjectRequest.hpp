...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_STUDIO_WORKBENCH_I_NEWPROJECT_REQUEST_HPP_INCLUDED
#define ZEN_STUDIO_WORKBENCH_I_NEWPROJECT_REQUEST_HPP_INCLUDED
...
namespace Memory {
    ...
    template<>
    struct is_managed_by_factory<Zen::Studio::Workbench::I_NewProjectRequest> : public boost::true_type{};
}   // namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_STUDIO_WORKBENCH_I_NEWPROJECT_REQUEST_HPP_INCLUDED
