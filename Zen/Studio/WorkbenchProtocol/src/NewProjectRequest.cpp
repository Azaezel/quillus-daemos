...
NewProjectRequest::getNodeId() const
{
    return m_nodeId;
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
NewProjectRequest::setNodeId(const boost::uint64_t& _nodeId)
{
    m_nodeId = _nodeId;
}
...
NewProjectRequest::createMessageHeader(boost::uint64_t _messageId)
{
...
{
    NewProjectRequest* pRequest = dynamic_cast<NewProjectRequest*>(_wpResponse.get());
