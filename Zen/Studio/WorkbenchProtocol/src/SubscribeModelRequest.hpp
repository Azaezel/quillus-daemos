...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_STUDIO_WORKBENCH_SUBSCRIBE_MODEL_REQUEST_HPP_INCLUDED
#define ZEN_STUDIO_WORKBENCH_SUBSCRIBE_MODEL_REQUEST_HPP_INCLUDED

#include "../I_SubscribeModelRequest.hpp"
...
class SubscribeModelRequest
:   public I_SubscribeModelRequest
,   public Message
{
    /// @name Types
    /// @{
public:
    enum { type = 5 };  // TODO Should we be hardcoding this?
...
public:
    ...
    /// @name SubscribeModelRequest implementation
    /// @{
public:
...
public:
    friend class MessageFactory;
             ...
             SubscribeModelRequest(pEndpoint_type _pSourceEndpoint,
                               pEndpoint_type _pDestinationEndpoint);
             /// This constructor is used by the message factory
             /// for creating inbound messages.
             SubscribeModelRequest(pMessageHeader_type _pMessageHeader,
                               pEndpoint_type _pSourceEndpoint,
                               pEndpoint_type _pDestinationEndpoint);
    virtual ~SubscribeModelRequest();
    /// @}
...
#endif // ZEN_STUDIO_WORKBENCH_SUBSCRIBE_MODEL_REQUEST_HPP_INCLUDED
