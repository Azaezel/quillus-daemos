...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_STUDIO_WORKBENCH_SUBSCRIBEMODEL_REQUEST_HPP_INCLUDED
#define ZEN_STUDIO_WORKBENCH_SUBSCRIBEMODEL_REQUEST_HPP_INCLUDED
...
,   public Request
{
    ...
    /// @{
public:
    enum { type = 115 };  // TODO Should we be hardcoding this?
...
public:
    ...
    /// @{
protected:
    friend class I_SubscribeModelRequest;
...
#endif // ZEN_STUDIO_WORKBENCH_SUBSCRIBEMODEL_REQUEST_HPP_INCLUDED
