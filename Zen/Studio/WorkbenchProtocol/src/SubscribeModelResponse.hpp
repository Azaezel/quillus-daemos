...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_STUDIO_WORKBENCH_SUBSCRIBEMODEL_RESPONSE_HPP_INCLUDED
#define ZEN_STUDIO_WORKBENCH_SUBSCRIBEMODEL_RESPONSE_HPP_INCLUDED
...
,   public Response
{
    ...
    /// @{
public:
    enum { type = 116 };  // TODO Should we be hardcoding this?
...
public:
    ...
    /// @{
protected:
    friend class I_SubscribeModelResponse;
...
#endif // ZEN_STUDIO_WORKBENCH_SUBSCRIBEMODEL_RESPONSE_HPP_INCLUDED
