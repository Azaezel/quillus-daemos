...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_STUDIO_WORKBENCH_SUBSCRIBE_MODEL_RESPONSE_HPP_INCLUDED
#define ZEN_STUDIO_WORKBENCH_SUBSCRIBE_MODEL_RESPONSE_HPP_INCLUDED

#include "../I_SubscribeModelResponse.hpp"
...
class SubscribeModelResponse
:   public I_SubscribeModelResponse
,   public Message
{
    /// @name Types
    /// @{
public:
    enum { type = 6 };  // TODO Should we be hardcoding this?
...
public:
    ...
    /// @name SubscribeModelResponse implementation
    /// @{
public:
...
public:
    friend class MessageFactory;
             ...
             SubscribeModelResponse(pEndpoint_type _pSourceEndpoint,
                               pEndpoint_type _pDestinationEndpoint);
             /// This constructor is used by the message factory
             /// for creating inbound messages.
             SubscribeModelResponse(pMessageHeader_type _pMessageHeader,
                               pEndpoint_type _pSourceEndpoint,
                               pEndpoint_type _pDestinationEndpoint);
    virtual ~SubscribeModelResponse();
    /// @}
...
#endif // ZEN_STUDIO_WORKBENCH_SUBSCRIBE_MODEL_RESPONSE_HPP_INCLUDED
