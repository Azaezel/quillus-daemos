...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_STUDIO_WORKBENCH_CHILDNODE_RESPONSE_HPP_INCLUDED
#define ZEN_STUDIO_WORKBENCH_CHILDNODE_RESPONSE_HPP_INCLUDED
...
,   public Response
{
    ...
    /// @{
public:
    enum { type = 112 };  // TODO Should we be hardcoding this?
...
public:
    ...
    /// @{
protected:
    friend class I_ChildNodeResponse;
...
#endif // ZEN_STUDIO_WORKBENCH_CHILDNODE_RESPONSE_HPP_INCLUDED
