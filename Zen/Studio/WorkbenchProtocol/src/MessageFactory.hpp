...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_STUDIO_WORKBENCHPROTOCOL_MESSAGE_FACTORY_HPP_INCLUDED
#define ZEN_STUDIO_WORKBENCHPROTOCOL_MESSAGE_FACTORY_HPP_INCLUDED
...
#endif // ZEN_STUDIO_WORKBENCHPROTOCOL_MESSAGE_FACTORY_HPP_INCLUDED
