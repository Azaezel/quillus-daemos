...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_STUDIO_WORKBENCH_NEW_PROJECT_REQUEST_HPP_INCLUDED
#define ZEN_STUDIO_WORKBENCH_NEW_PROJECT_REQUEST_HPP_INCLUDED

#include "../I_NewProjectRequest.hpp"
...
:   public I_NewProjectRequest
,   public Message
{
    /// @name Types
    /// @{
public:
    enum { type = 1 };  // TODO Should we be hardcoding this?
...
public:
    ...
    /// @name NewProjectRequest implementation
    /// @{
public:
...
public:
    friend class MessageFactory;
             ...
             NewProjectRequest(pEndpoint_type _pSourceEndpoint,
                               pEndpoint_type _pDestinationEndpoint);
             /// This constructor is used by the message factory
             /// for creating inbound messages.
             NewProjectRequest(pMessageHeader_type _pMessageHeader,
                               pEndpoint_type _pSourceEndpoint,
                               pEndpoint_type _pDestinationEndpoint);
    virtual ~NewProjectRequest();
    /// @}
...
#endif // ZEN_STUDIO_WORKBENCH_NEW_PROJECT_REQUEST_HPP_INCLUDED
