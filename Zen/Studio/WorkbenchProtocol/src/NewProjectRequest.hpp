...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_STUDIO_WORKBENCH_NEWPROJECT_REQUEST_HPP_INCLUDED
#define ZEN_STUDIO_WORKBENCH_NEWPROJECT_REQUEST_HPP_INCLUDED
...
public:
    ...
    /// @{
protected:
    friend class I_NewProjectRequest;
