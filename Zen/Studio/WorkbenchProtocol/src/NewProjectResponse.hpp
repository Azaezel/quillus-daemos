...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_STUDIO_WORKBENCH_NEW_PROJECT_RESPONSE_HPP_INCLUDED
#define ZEN_STUDIO_WORKBENCH_NEW_PROJECT_RESPONSE_HPP_INCLUDED

#include "../I_NewProjectResponse.hpp"
...
public:
    ...
    /// @name NewProjectResponse implementation
    /// @{
public:
...
public:
    friend class MessageFactory;
             ...
             NewProjectResponse(pEndpoint_type _pSourceEndpoint,
                                pEndpoint_type _pDestinationEndpoint);
             /// This constructor is used by the message factory
             /// for creating inbound messages.
             NewProjectResponse(pMessageHeader_type _pMessageHeader,
                                pEndpoint_type _pSourceEndpoint,
                                pEndpoint_type _pDestinationEndpoint);
    virtual ~NewProjectResponse();
    /// @}
...
#endif // ZEN_STUDIO_WORKBENCH_NEW_PROJECT_RESPONSE_HPP_INCLUDED
