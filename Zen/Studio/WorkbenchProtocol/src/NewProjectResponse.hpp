...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_STUDIO_WORKBENCH_NEWPROJECT_RESPONSE_HPP_INCLUDED
#define ZEN_STUDIO_WORKBENCH_NEWPROJECT_RESPONSE_HPP_INCLUDED
...
,   public Response
{
    ...
    /// @{
public:
    enum { type = 114 };  // TODO Should we be hardcoding this?
...
public:
    ...
    /// @{
protected:
    friend class I_NewProjectResponse;
...
#endif // ZEN_STUDIO_WORKBENCH_NEWPROJECT_RESPONSE_HPP_INCLUDED
