...
SubscribeModelRequest::getNodeId() const
{
    return m_nodeId;
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
SubscribeModelRequest::setNodeId(const boost::uint64_t& _nodeId)
{
    m_nodeId = _nodeId;
}
...
SubscribeModelRequest::createMessageHeader(boost::uint64_t _messageId)
{
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
SubscribeModelRequest::destroy(wpRequest_type _wpResponse)
{
    SubscribeModelRequest* pRequest = dynamic_cast<SubscribeModelRequest*>(_wpResponse.get());
...
SubscribeModelRequest::getDestinationLocation()
{
    ...
    {
        sm_pResourceLocation = Zen::Enterprise::AppServer::I_ApplicationServerManager::getSingleton().createLocation("/workbenchServer");
    }
