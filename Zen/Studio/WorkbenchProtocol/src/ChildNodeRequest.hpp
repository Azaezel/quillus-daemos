...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_STUDIO_WORKBENCH_CHILD_NODE_REQUEST_HPP_INCLUDED
#define ZEN_STUDIO_WORKBENCH_CHILD_NODE_REQUEST_HPP_INCLUDED
...
public:
    ...
    /// @name ChildNodeRequest implementation
    /// @{
public:
...
#endif // ZEN_STUDIO_WORKBENCH_CHILD_NODE_REQUEST_HPP_INCLUDED
