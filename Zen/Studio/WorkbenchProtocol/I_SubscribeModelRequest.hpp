...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_STUDIO_WORKBENCH_I_SUBSCRIBE_MODEL_REQUEST_HPP_INCLUDED
#define ZEN_STUDIO_WORKBENCH_I_SUBSCRIBE_MODEL_REQUEST_HPP_INCLUDED
...
public:
    ...
    /// @name I_SubscribeModelRequest interface
    /// @{
public:
    /// @}
...
namespace Memory {
    ...
    template<>
    struct is_managed_by_factory<Studio::Workbench::I_SubscribeModelRequest> : public boost::true_type{};
}   // namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_STUDIO_WORKBENCH_I_SUBSCRIBE_MODEL_REQUEST_HPP_INCLUDED
