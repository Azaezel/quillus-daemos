...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_STUDIO_WORKBENCH_SPREADSHEETDOCUMENT_DOMAIN_OBJECT_HPP_INCLUDED
#define ZEN_STUDIO_WORKBENCH_SPREADSHEETDOCUMENT_DOMAIN_OBJECT_HPP_INCLUDED

#include "../I_SpreadSheetDocumentDomainObject.hpp"
...
class SpreadSheetDocumentDomainObject
:	public I_SpreadSheetDocumentDomainObject
{
    /// @name Types
    /// @{
public:
...
private:
    ...
    /// @{
public:
             SpreadSheetDocumentDomainObject();
    virtual ~SpreadSheetDocumentDomainObject();
    /// @}
...
#endif // ZEN_STUDIO_WORKBENCH_SPREADSHEETDOCUMENT_DOMAIN_OBJECT_HPP_INCLUDED
