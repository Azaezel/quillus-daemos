...
IMPLEMENT_SINGLE_ZEN_PLUGIN(GameClientModule, GameClientPlugin)

BEGIN_ZEN_EXTENSION_MAP(GameClientPlugin)
    ZEN_EXTENSION("Zen::Engine::Client::GameClient", &Game::Client::GameClientFactory::getSingleton())
