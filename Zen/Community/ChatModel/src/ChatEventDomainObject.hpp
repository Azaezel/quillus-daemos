...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_CHAT_CHATEVENT_DOMAIN_OBJECT_HPP_INCLUDED
#define ZEN_COMMUNITY_CHAT_CHATEVENT_DOMAIN_OBJECT_HPP_INCLUDED

#include "../I_ChatEventDomainObject.hpp"
...
class ChatEventDomainObject
:	public I_ChatEventDomainObject
{
    /// @name Types
    /// @{
public:
...
public:
    ...
    virtual ElementReference_type getChatEventId() const;
    ...
    /// to be persisted.
    virtual void setChatEventId(const boost::any& _value);

    /// Get the Event element.
    /// Use this return value to check to see if the column is NULL in the database,
    /// or you can use it to modify the value instead of calling setEvent().
    virtual ElementReference_type getEvent() const;
    
    /// Set the Event element value.
    /// This method does not directly update the database.  
    /// You must use the I_ChatEventDataMap::update() method for the modifications
    /// to be persisted.
    virtual void setEvent(const boost::any& _value);
    ...
    /// @{
private:
    pElement_type               m_pChatEventId;
    pElement_type               m_pEvent;
    ...
    /// @{
public:
             ChatEventDomainObject();
    virtual ~ChatEventDomainObject();
    /// @}
...
#endif // ZEN_COMMUNITY_CHAT_CHATEVENT_DOMAIN_OBJECT_HPP_INCLUDED
