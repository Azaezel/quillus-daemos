...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_CHAT_I_ALLOWUSER_DOMAIN_OBJECT_HPP_INCLUDED
#define ZEN_COMMUNITY_CHAT_I_ALLOWUSER_DOMAIN_OBJECT_HPP_INCLUDED
...
class CHATMODEL_DLL_LINK I_AllowUserDomainObject
...
public:
    ...
    virtual ElementReference_type getAllowUserId() const = 0;
    ...
    /// to be persisted.
    virtual void setAllowUserId(const boost::any& _value) = 0;
    ...
    /// @{
protected:
             I_AllowUserDomainObject();
    virtual ~I_AllowUserDomainObject();
    /// @}

};  // interface I_AllowUserDomainObject
...
namespace Zen {
namespace Memory {
    /// I_AllowUserDomainObject is a managed by factory
    template<>
    struct is_managed_by_factory<Zen::Community::Chat::I_AllowUserDomainObject> : public boost::true_type{};
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
}   // namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_COMMUNITY_CHAT_I_ALLOWUSER_DOMAIN_OBJECT_HPP_INCLUDED
