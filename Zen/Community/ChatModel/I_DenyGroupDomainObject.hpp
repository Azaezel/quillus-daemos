...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_CHAT_I_DENYGROUP_DOMAIN_OBJECT_HPP_INCLUDED
#define ZEN_COMMUNITY_CHAT_I_DENYGROUP_DOMAIN_OBJECT_HPP_INCLUDED
...
class CHATMODEL_DLL_LINK I_DenyGroupDomainObject
...
public:
    ...
    virtual ElementReference_type getDenyGroupId() const = 0;
    ...
    /// to be persisted.
    virtual void setDenyGroupId(const boost::any& _value) = 0;
    ...
    /// @{
protected:
             I_DenyGroupDomainObject();
    virtual ~I_DenyGroupDomainObject();
    /// @}

};  // interface I_DenyGroupDomainObject
...
namespace Zen {
namespace Memory {
    /// I_DenyGroupDomainObject is a managed by factory
    template<>
    struct is_managed_by_factory<Zen::Community::Chat::I_DenyGroupDomainObject> : public boost::true_type{};
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
}   // namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_COMMUNITY_CHAT_I_DENYGROUP_DOMAIN_OBJECT_HPP_INCLUDED
