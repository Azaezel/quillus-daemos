...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_CHATCOMMON_CHANNEL_MEMBER_MODEL_HPP_INCLUDED
#define ZEN_COMMUNITY_CHATCOMMON_CHANNEL_MEMBER_MODEL_HPP_INCLUDED
...
namespace Common {
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
class I_ChannelMemberView;
class I_Session;

// This is a non-persisted model
class CHATCOMMON_DLL_LINK I_ChannelMemberModel
:   boost::noncopyable
{
    /// @name Types
    /// @{
public:
    typedef Memory::managed_ptr<I_ChannelMemberView>                    pChannelMemberView_type;
    ...
    typedef Memory::managed_weak_ptr<I_Session>                         wpSession_type;
    /// @}

    /// @name I_ChannelMemberModel interface
    /// @{
public:
    ...
    virtual pFutureSubscription_type subscribe(Common::I_Session& _session, pChannelMemberView_type _pView, pFilter_type _pFilter = pFilter_type()) = 0;

    virtual Event::I_Event& getChannelMemberEvent() = 0;
    /// @}

    /// @name 'Structors
    /// @{
protected:
             I_ChannelMemberModel();
    virtual ~I_ChannelMemberModel();
    /// @}

};  // interface I_ChannelMemberModel

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
}   // namespace Common
}   // namespace Community
namespace Memory {
	/// I_ChannelMemberModel is managed by factory
	template<>
	struct is_managed_by_factory<Community::Common::I_ChannelMemberModel> : public boost::true_type{};
}	// namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_COMMUNITY_CHATCOMMON_CHANNEL_MEMBER_MODEL_HPP_INCLUDED
