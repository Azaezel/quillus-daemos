...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_CHATCOMMON_CHAT_COMMAND_MODEL_HPP_INCLUDED
#define ZEN_COMMUNITY_CHATCOMMON_CHAT_COMMAND_MODEL_HPP_INCLUDED
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
class I_ChatCommand;
class I_ChatCommandView;
class I_Session;

class CHATCOMMON_DLL_LINK I_ChatCommandModel
:   boost::noncopyable
{
    /// @name Types
    /// @{
public:
    typedef Memory::managed_ptr<I_ChatCommandView>                          pChatCommandView_type;
    ...
    /// @name I_ChatCommandModel interface
    /// @{
public:
    ...
    virtual pFutureSubscription_type subscribe(Common::I_Session& _session, pChatCommandView_type _pView, pFilter_type _pFilter = pFilter_type()) = 0;

    virtual Event::I_Event& getChatCommandEvent() = 0;
    /// @}
...
protected:
             I_ChatCommandModel();
    virtual ~I_ChatCommandModel();
    /// @}

};  // interface I_ChatCommandModel

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
}   // namespace Common
}   // namespace Community
namespace Memory {
	/// I_ChatCommandModel is managed by factory
	template<>
	struct is_managed_by_factory<Community::Common::I_ChatCommandModel> : public boost::true_type{};
}	// namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_COMMUNITY_CHATCOMMON_CHAT_COMMAND_MODEL_HPP_INCLUDED
