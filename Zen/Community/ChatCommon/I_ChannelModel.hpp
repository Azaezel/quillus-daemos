...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_CHATCOMMON_CHANNEL_MODEL_HPP_INCLUDED
#define ZEN_COMMUNITY_CHATCOMMON_CHANNEL_MODEL_HPP_INCLUDED
...
class CHATCOMMON_DLL_LINK I_ChannelModel
:   boost::noncopyable
{
    /// @name Types
    /// @{
public:
    typedef Memory::managed_ptr<I_ChannelView>                          pChannelView_type;
...
public:
    ...
    virtual pFutureSubscription_type subscribe(Common::I_Session& _session, pChannelView_type _pView, pFilter_type _pFilter = pFilter_type()) = 0;

    virtual Event::I_Event& getChannelEvent() = 0;
    /// @}
...
protected:
             I_ChannelModel();
    virtual ~I_ChannelModel();
    /// @}

};  // interface I_ChannelModel

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
}   // namespace Common
}   // namespace Community
namespace Memory {
	/// I_ChannelModel is managed by factory
	template<>
	struct is_managed_by_factory<Community::Common::I_ChannelModel> : public boost::true_type{};
}	// namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_COMMUNITY_CHATCOMMON_CHANNEL_MODEL_HPP_INCLUDED
