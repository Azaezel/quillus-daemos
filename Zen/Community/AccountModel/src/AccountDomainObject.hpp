...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNT_ACCOUNT_DOMAIN_OBJECT_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNT_ACCOUNT_DOMAIN_OBJECT_HPP_INCLUDED
...
#endif // ZEN_COMMUNITY_ACCOUNT_ACCOUNT_DOMAIN_OBJECT_HPP_INCLUDED
