...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_I_DELETECHANNEL_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_I_DELETECHANNEL_REQUEST_HPP_INCLUDED
...
class CHATPROTOCOL_DLL_LINK I_DeleteChannelRequest
...
public:
    ...
    /// @{
protected:
             I_DeleteChannelRequest();
    virtual ~I_DeleteChannelRequest();
    /// @}

};  // interface I_DeleteChannelRequest
...
namespace Zen {
namespace Memory {
    // I_DeleteChannelRequest is managed by factory
    template<>
    struct is_managed_by_factory<Zen::Community::Protocol::I_DeleteChannelRequest> : public boost::true_type{};
}   // namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_COMMUNITY_PROTOCOL_I_DELETECHANNEL_REQUEST_HPP_INCLUDED
