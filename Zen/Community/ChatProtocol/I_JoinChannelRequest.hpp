...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_I_JOINCHANNEL_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_I_JOINCHANNEL_REQUEST_HPP_INCLUDED
...
class CHATPROTOCOL_DLL_LINK I_JoinChannelRequest
...
public:
    ...
    /// @{
protected:
             I_JoinChannelRequest();
    virtual ~I_JoinChannelRequest();
    /// @}

};  // interface I_JoinChannelRequest
...
namespace Zen {
namespace Memory {
    // I_JoinChannelRequest is managed by factory
    template<>
    struct is_managed_by_factory<Zen::Community::Protocol::I_JoinChannelRequest> : public boost::true_type{};
}   // namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_COMMUNITY_PROTOCOL_I_JOINCHANNEL_REQUEST_HPP_INCLUDED
