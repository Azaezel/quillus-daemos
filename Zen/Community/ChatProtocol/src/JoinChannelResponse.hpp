...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_JOINCHANNEL_RESPONSE_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_JOINCHANNEL_RESPONSE_HPP_INCLUDED

#include "../I_JoinChannelResponse.hpp"
...
:   public I_JoinChannelResponse
,   public Response
{
    /// @name Types
    /// @{
public:
    enum { type = 314 };  // TODO Should we be hardcoding this?
...
protected:
    ...
    friend class MessageFactory;
             ...
             JoinChannelResponse(pMessageHeader_type _pMessageHeader,
...
#endif // ZEN_COMMUNITY_PROTOCOL_JOINCHANNEL_RESPONSE_HPP_INCLUDED
