...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_UPDATECHANNEL_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_UPDATECHANNEL_REQUEST_HPP_INCLUDED

#include "../I_UpdateChannelRequest.hpp"
...
:   public I_UpdateChannelRequest
,   public Request
{
    /// @name Types
    /// @{
public:
    enum { type = 309 };  // TODO Should we be hardcoding this?
...
#endif // ZEN_COMMUNITY_PROTOCOL_UPDATECHANNEL_REQUEST_HPP_INCLUDED
