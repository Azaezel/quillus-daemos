...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_DELETECHANNEL_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_DELETECHANNEL_REQUEST_HPP_INCLUDED

#include "../I_DeleteChannelRequest.hpp"
...
:   public I_DeleteChannelRequest
,   public Request
{
    /// @name Types
    /// @{
public:
    enum { type = 311 };  // TODO Should we be hardcoding this?
...
#endif // ZEN_COMMUNITY_PROTOCOL_DELETECHANNEL_REQUEST_HPP_INCLUDED
