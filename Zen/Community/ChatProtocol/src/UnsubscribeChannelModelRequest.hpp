...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_UNSUBSCRIBECHANNELMODEL_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_UNSUBSCRIBECHANNELMODEL_REQUEST_HPP_INCLUDED

#include "../I_UnsubscribeChannelModelRequest.hpp"
...
namespace Protocol {
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
class UnsubscribeChannelModelRequest
:   public I_UnsubscribeChannelModelRequest
,   public Request
{
    /// @name Types
    /// @{
public:
    enum { type = 303 };  // TODO Should we be hardcoding this?
...
public:
    ...
    /// @{
protected:
    friend class I_UnsubscribeChannelModelRequest;
    friend class MessageFactory;
             /// This constructor is used by the static create
             /// methods for creating outbound messages.
             UnsubscribeChannelModelRequest(pEndpoint_type _pSourceEndpoint,
                           pEndpoint_type _pDestinationEndpoint);
             /// This constructor is used by the message factory
             /// for creating inbound messages.
             UnsubscribeChannelModelRequest(pMessageHeader_type _pMessageHeader,
                           pEndpoint_type _pSourceEndpoint,
                           pEndpoint_type _pDestinationEndpoint);
    virtual ~UnsubscribeChannelModelRequest();
    /// @}
...
#endif // ZEN_COMMUNITY_PROTOCOL_UNSUBSCRIBECHANNELMODEL_REQUEST_HPP_INCLUDED
