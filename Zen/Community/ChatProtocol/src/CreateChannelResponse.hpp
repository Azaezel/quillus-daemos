...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_CREATECHANNEL_RESPONSE_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_CREATECHANNEL_RESPONSE_HPP_INCLUDED

#include "../I_CreateChannelResponse.hpp"
...
:   public I_CreateChannelResponse
,   public Response
{
    /// @name Types
    /// @{
public:
    enum { type = 306 };  // TODO Should we be hardcoding this?
...
public:
    ...
    /// @{
protected:
    friend class I_CreateChannelResponse;
    friend class MessageFactory;
             /// This constructor is used by the static create
             /// methods for creating outbound messages.
             CreateChannelResponse(pEndpoint_type _pSourceEndpoint,
             ...
             CreateChannelResponse(pMessageHeader_type _pMessageHeader,
...
#endif // ZEN_COMMUNITY_PROTOCOL_CREATECHANNEL_RESPONSE_HPP_INCLUDED
