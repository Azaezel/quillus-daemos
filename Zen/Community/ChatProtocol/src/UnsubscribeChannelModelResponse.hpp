...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_UNSUBSCRIBECHANNELMODEL_RESPONSE_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_UNSUBSCRIBECHANNELMODEL_RESPONSE_HPP_INCLUDED

#include "../I_UnsubscribeChannelModelResponse.hpp"
...
namespace Protocol {
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
class UnsubscribeChannelModelResponse
:   public I_UnsubscribeChannelModelResponse
,   public Response
{
    /// @name Types
    /// @{
public:
    enum { type = 304 };  // TODO Should we be hardcoding this?
...
public:
    ...
    /// @{
protected:
    friend class I_UnsubscribeChannelModelResponse;
    friend class MessageFactory;
             /// This constructor is used by the static create
             /// methods for creating outbound messages.
             UnsubscribeChannelModelResponse(pEndpoint_type _pSourceEndpoint,
             ...
             UnsubscribeChannelModelResponse(pMessageHeader_type _pMessageHeader,
                           pEndpoint_type _pSourceEndpoint,
                           pEndpoint_type _pDestinationEndpoint);
    virtual ~UnsubscribeChannelModelResponse();
    /// @}
...
#endif // ZEN_COMMUNITY_PROTOCOL_UNSUBSCRIBECHANNELMODEL_RESPONSE_HPP_INCLUDED
