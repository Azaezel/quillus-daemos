...
namespace Protocol {
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
ReadChannelRequest::pMessageType_type ReadChannelRequest::sm_pType;
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
Zen::Enterprise::AppServer::I_MessageRegistry* ReadChannelRequest::sm_pMessageRegistry = NULL;
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
ReadChannelRequest::ReadChannelRequest(pEndpoint_type _pSourceEndpoint,
                           pEndpoint_type _pDestinationEndpoint)
:   Request(ReadChannelRequest::createMessageHeader(getNewMessageId()), _pSourceEndpoint, _pDestinationEndpoint)        
{
}

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
ReadChannelRequest::ReadChannelRequest(pMessageHeader_type _pMessageHeader,
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
ReadChannelRequest::~ReadChannelRequest()
{
}

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
ReadChannelRequest::serialize(pMessageHeader_type _pHeader, boost::archive::polymorphic_iarchive& _archive, const int _version)
{
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
ReadChannelRequest::serialize(boost::archive::polymorphic_oarchive& _archive, const int _version)
{
    _archive & m_sessionId;
    _archive & m_name;
}
...
ReadChannelRequest::getSessionId() const
{
    return m_sessionId;
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
ReadChannelRequest::setSessionId(const boost::uint64_t& _sessionId)
{
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
const std::string&
ReadChannelRequest::getName() const
{
    return m_name;
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
ReadChannelRequest::setName(const std::string& _name)
{
    m_name = _name;
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
ReadChannelRequest::registerMessage(Zen::Enterprise::AppServer::I_ApplicationServer& _appServer)
{
...
ReadChannelRequest::createMessageHeader(boost::uint32_t _messageId)
{
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
ReadChannelRequest::destroy(wpRequest_type _wpResponse)
{
    ReadChannelRequest* pRequest = dynamic_cast<ReadChannelRequest*>(_wpResponse.get());
    ...
    {
        throw Zen::Utility::runtime_exception("ReadChannelRequest::destroy() : Invalid type.");
    }
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
ReadChannelRequest::pResourceLocation_type
ReadChannelRequest::getDestinationLocation()
{
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
ReadChannelRequest::pMessageType_type
ReadChannelRequest::getStaticMessageType()
{
    return sm_pType;
}
