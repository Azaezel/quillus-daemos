...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_DELETECHANNEL_RESPONSE_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_DELETECHANNEL_RESPONSE_HPP_INCLUDED

#include "../I_DeleteChannelResponse.hpp"
...
:   public I_DeleteChannelResponse
,   public Response
{
    /// @name Types
    /// @{
public:
    enum { type = 312 };  // TODO Should we be hardcoding this?
...
public:
    ...
    /// @{
protected:
    friend class I_DeleteChannelResponse;
    friend class MessageFactory;
             /// This constructor is used by the static create
             /// methods for creating outbound messages.
             DeleteChannelResponse(pEndpoint_type _pSourceEndpoint,
             ...
             DeleteChannelResponse(pMessageHeader_type _pMessageHeader,
                           pEndpoint_type _pSourceEndpoint,
                           pEndpoint_type _pDestinationEndpoint);
    virtual ~DeleteChannelResponse();
    /// @}
...
#endif // ZEN_COMMUNITY_PROTOCOL_DELETECHANNEL_RESPONSE_HPP_INCLUDED
