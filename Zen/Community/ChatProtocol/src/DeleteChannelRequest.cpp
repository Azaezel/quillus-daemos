...
namespace Protocol {
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
DeleteChannelRequest::pMessageType_type DeleteChannelRequest::sm_pType;
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
Zen::Enterprise::AppServer::I_MessageRegistry* DeleteChannelRequest::sm_pMessageRegistry = NULL;
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
DeleteChannelRequest::DeleteChannelRequest(pEndpoint_type _pSourceEndpoint,
                           pEndpoint_type _pDestinationEndpoint)
:   Request(DeleteChannelRequest::createMessageHeader(getNewMessageId()), _pSourceEndpoint, _pDestinationEndpoint)        
{
}

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
DeleteChannelRequest::DeleteChannelRequest(pMessageHeader_type _pMessageHeader,
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
DeleteChannelRequest::serialize(pMessageHeader_type _pHeader, boost::archive::polymorphic_iarchive& _archive, const int _version)
{
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
DeleteChannelRequest::serialize(boost::archive::polymorphic_oarchive& _archive, const int _version)
{
    _archive & m_sessionId;
    _archive & m_channelId;
}
...
DeleteChannelRequest::getSessionId() const
{
    return m_sessionId;
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
DeleteChannelRequest::setSessionId(const boost::uint64_t& _sessionId)
{
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
const boost::uint64_t&
DeleteChannelRequest::getChannelId() const
{
    return m_channelId;
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
DeleteChannelRequest::setChannelId(const boost::uint64_t& _channelId)
{
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
DeleteChannelRequest::registerMessage(Zen::Enterprise::AppServer::I_ApplicationServer& _appServer)
{
...
DeleteChannelRequest::createMessageHeader(boost::uint32_t _messageId)
{
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
DeleteChannelRequest::destroy(wpRequest_type _wpResponse)
{
    DeleteChannelRequest* pRequest = dynamic_cast<DeleteChannelRequest*>(_wpResponse.get());
    ...
    {
        throw Zen::Utility::runtime_exception("DeleteChannelRequest::destroy() : Invalid type.");
    }
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
DeleteChannelRequest::pResourceLocation_type
DeleteChannelRequest::getDestinationLocation()
{
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
DeleteChannelRequest::pMessageType_type
DeleteChannelRequest::getStaticMessageType()
{
    return sm_pType;
}
