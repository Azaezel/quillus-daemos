...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_READCHANNEL_RESPONSE_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_READCHANNEL_RESPONSE_HPP_INCLUDED

#include "../I_ReadChannelResponse.hpp"
...
namespace Protocol {
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
class ReadChannelResponse
:   public I_ReadChannelResponse
,   public Response
{
    /// @name Types
    /// @{
public:
    enum { type = 308 };  // TODO Should we be hardcoding this?
...
protected:
    ...
    friend class MessageFactory;
             ...
             ReadChannelResponse(pMessageHeader_type _pMessageHeader,
                           pEndpoint_type _pSourceEndpoint,
                           pEndpoint_type _pDestinationEndpoint);
    virtual ~ReadChannelResponse();
    /// @}
...
#endif // ZEN_COMMUNITY_PROTOCOL_READCHANNEL_RESPONSE_HPP_INCLUDED
