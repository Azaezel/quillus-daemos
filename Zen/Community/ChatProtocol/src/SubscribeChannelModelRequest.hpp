...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_SUBSCRIBECHANNELMODEL_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_SUBSCRIBECHANNELMODEL_REQUEST_HPP_INCLUDED

#include "../I_SubscribeChannelModelRequest.hpp"
...
namespace Protocol {
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
class SubscribeChannelModelRequest
:   public I_SubscribeChannelModelRequest
,   public Request
{
    /// @name Types
    /// @{
public:
    enum { type = 301 };  // TODO Should we be hardcoding this?
...
public:
    ...
    /// @{
protected:
    friend class I_SubscribeChannelModelRequest;
    friend class MessageFactory;
             /// This constructor is used by the static create
             /// methods for creating outbound messages.
             SubscribeChannelModelRequest(pEndpoint_type _pSourceEndpoint,
                           pEndpoint_type _pDestinationEndpoint);
             /// This constructor is used by the message factory
             /// for creating inbound messages.
             SubscribeChannelModelRequest(pMessageHeader_type _pMessageHeader,
                           pEndpoint_type _pSourceEndpoint,
                           pEndpoint_type _pDestinationEndpoint);
    virtual ~SubscribeChannelModelRequest();
    /// @}
...
#endif // ZEN_COMMUNITY_PROTOCOL_SUBSCRIBECHANNELMODEL_REQUEST_HPP_INCLUDED
