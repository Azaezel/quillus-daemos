...
namespace Protocol {
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
UnsubscribeChannelModelResponse::pMessageType_type UnsubscribeChannelModelResponse::sm_pType;
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
Zen::Enterprise::AppServer::I_MessageRegistry* UnsubscribeChannelModelResponse::sm_pMessageRegistry = NULL;
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
UnsubscribeChannelModelResponse::UnsubscribeChannelModelResponse(pEndpoint_type _pSourceEndpoint,
                           pEndpoint_type _pDestinationEndpoint, boost::uint64_t _requestMessageId)
:   Response(UnsubscribeChannelModelResponse::createMessageHeader(getNewMessageId(), _requestMessageId), _pSourceEndpoint, _pDestinationEndpoint)        
{
}

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
UnsubscribeChannelModelResponse::UnsubscribeChannelModelResponse(pMessageHeader_type _pMessageHeader,
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
UnsubscribeChannelModelResponse::~UnsubscribeChannelModelResponse()
{
}

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
UnsubscribeChannelModelResponse::serialize(pMessageHeader_type _pHeader, boost::archive::polymorphic_iarchive& _archive, const int _version)
{
}

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
UnsubscribeChannelModelResponse::serialize(boost::archive::polymorphic_oarchive& _archive, const int _version)
{
}

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
UnsubscribeChannelModelResponse::registerMessage(Zen::Enterprise::AppServer::I_ApplicationServer& _appServer)
{
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
UnsubscribeChannelModelResponse::destroy(wpResponse_type _wpResponse)
{
    UnsubscribeChannelModelResponse* pResponse = dynamic_cast<UnsubscribeChannelModelResponse*>(_wpResponse.get());
    ...
    {
        throw Zen::Utility::runtime_exception("UnsubscribeChannelModelResponse::destroy() : Invalid type.");
    }
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
UnsubscribeChannelModelResponse::pResourceLocation_type
UnsubscribeChannelModelResponse::getDestinationLocation()
{
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
UnsubscribeChannelModelResponse::pMessageType_type
UnsubscribeChannelModelResponse::getStaticMessageType()
{
    return sm_pType;
}
