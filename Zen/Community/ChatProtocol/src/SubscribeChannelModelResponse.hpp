...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_SUBSCRIBECHANNELMODEL_RESPONSE_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_SUBSCRIBECHANNELMODEL_RESPONSE_HPP_INCLUDED

#include "../I_SubscribeChannelModelResponse.hpp"
...
namespace Protocol {
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
class SubscribeChannelModelResponse
:   public I_SubscribeChannelModelResponse
,   public Response
{
    /// @name Types
    /// @{
public:
    enum { type = 302 };  // TODO Should we be hardcoding this?
...
public:
    ...
    /// @{
protected:
    friend class I_SubscribeChannelModelResponse;
    friend class MessageFactory;
             /// This constructor is used by the static create
             /// methods for creating outbound messages.
             SubscribeChannelModelResponse(pEndpoint_type _pSourceEndpoint,
             ...
             SubscribeChannelModelResponse(pMessageHeader_type _pMessageHeader,
                           pEndpoint_type _pSourceEndpoint,
                           pEndpoint_type _pDestinationEndpoint);
    virtual ~SubscribeChannelModelResponse();
    /// @}
...
#endif // ZEN_COMMUNITY_PROTOCOL_SUBSCRIBECHANNELMODEL_RESPONSE_HPP_INCLUDED
