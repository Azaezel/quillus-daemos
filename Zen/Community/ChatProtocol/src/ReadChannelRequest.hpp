...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_READCHANNEL_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_READCHANNEL_REQUEST_HPP_INCLUDED

#include "../I_ReadChannelRequest.hpp"
...
namespace Protocol {
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
class ReadChannelRequest
:   public I_ReadChannelRequest
,   public Request
{
    /// @name Types
    /// @{
public:
    enum { type = 307 };  // TODO Should we be hardcoding this?
...
#endif // ZEN_COMMUNITY_PROTOCOL_READCHANNEL_REQUEST_HPP_INCLUDED
