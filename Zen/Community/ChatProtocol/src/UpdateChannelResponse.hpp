...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_UPDATECHANNEL_RESPONSE_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_UPDATECHANNEL_RESPONSE_HPP_INCLUDED

#include "../I_UpdateChannelResponse.hpp"
...
:   public I_UpdateChannelResponse
,   public Response
{
    /// @name Types
    /// @{
public:
    enum { type = 310 };  // TODO Should we be hardcoding this?
...
public:
    ...
    /// @{
protected:
    friend class I_UpdateChannelResponse;
    friend class MessageFactory;
             /// This constructor is used by the static create
             /// methods for creating outbound messages.
             UpdateChannelResponse(pEndpoint_type _pSourceEndpoint,
             ...
             UpdateChannelResponse(pMessageHeader_type _pMessageHeader,
                           pEndpoint_type _pSourceEndpoint,
                           pEndpoint_type _pDestinationEndpoint);
    virtual ~UpdateChannelResponse();
    /// @}
...
#endif // ZEN_COMMUNITY_PROTOCOL_UPDATECHANNEL_RESPONSE_HPP_INCLUDED
