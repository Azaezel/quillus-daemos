...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_CREATECHANNEL_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_CREATECHANNEL_REQUEST_HPP_INCLUDED

#include "../I_CreateChannelRequest.hpp"
...
:   public I_CreateChannelRequest
,   public Request
{
    /// @name Types
    /// @{
public:
    enum { type = 305 };  // TODO Should we be hardcoding this?
...
#endif // ZEN_COMMUNITY_PROTOCOL_CREATECHANNEL_REQUEST_HPP_INCLUDED
