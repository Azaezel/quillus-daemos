...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_I_READCHANNEL_RESPONSE_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_I_READCHANNEL_RESPONSE_HPP_INCLUDED
...
class CHATPROTOCOL_DLL_LINK I_ReadChannelResponse
...
public:
    ...
    /// @{
protected:
             I_ReadChannelResponse();
    virtual ~I_ReadChannelResponse();
    /// @}

};  // interface I_ReadChannelResponse
...
namespace Zen {
namespace Memory {
    // I_ReadChannelResponse is managed by factory
    template<>
    struct is_managed_by_factory<Zen::Community::Protocol::I_ReadChannelResponse> : public boost::true_type{};
}   // namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_COMMUNITY_PROTOCOL_I_READCHANNEL_RESPONSE_HPP_INCLUDED
