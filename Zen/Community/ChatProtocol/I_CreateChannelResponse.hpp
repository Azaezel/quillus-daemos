...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_I_CREATECHANNEL_RESPONSE_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_I_CREATECHANNEL_RESPONSE_HPP_INCLUDED
...
class CHATPROTOCOL_DLL_LINK I_CreateChannelResponse
...
public:
    ...
    /// @{
protected:
             I_CreateChannelResponse();
    virtual ~I_CreateChannelResponse();
    /// @}

};  // interface I_CreateChannelResponse
...
namespace Zen {
namespace Memory {
    // I_CreateChannelResponse is managed by factory
    template<>
    struct is_managed_by_factory<Zen::Community::Protocol::I_CreateChannelResponse> : public boost::true_type{};
}   // namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_COMMUNITY_PROTOCOL_I_CREATECHANNEL_RESPONSE_HPP_INCLUDED
