...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_I_READCHANNEL_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_I_READCHANNEL_REQUEST_HPP_INCLUDED
...
class CHATPROTOCOL_DLL_LINK I_ReadChannelRequest
...
public:
    ...
    /// @{
protected:
             I_ReadChannelRequest();
    virtual ~I_ReadChannelRequest();
    /// @}

};  // interface I_ReadChannelRequest
...
namespace Zen {
namespace Memory {
    // I_ReadChannelRequest is managed by factory
    template<>
    struct is_managed_by_factory<Zen::Community::Protocol::I_ReadChannelRequest> : public boost::true_type{};
}   // namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_COMMUNITY_PROTOCOL_I_READCHANNEL_REQUEST_HPP_INCLUDED
