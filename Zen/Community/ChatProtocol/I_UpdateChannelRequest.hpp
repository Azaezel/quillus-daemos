...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_I_UPDATECHANNEL_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_I_UPDATECHANNEL_REQUEST_HPP_INCLUDED
...
class CHATPROTOCOL_DLL_LINK I_UpdateChannelRequest
...
public:
    ...
    /// @{
protected:
             I_UpdateChannelRequest();
    virtual ~I_UpdateChannelRequest();
    /// @}

};  // interface I_UpdateChannelRequest
...
namespace Zen {
namespace Memory {
    // I_UpdateChannelRequest is managed by factory
    template<>
    struct is_managed_by_factory<Zen::Community::Protocol::I_UpdateChannelRequest> : public boost::true_type{};
}   // namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_COMMUNITY_PROTOCOL_I_UPDATECHANNEL_REQUEST_HPP_INCLUDED
