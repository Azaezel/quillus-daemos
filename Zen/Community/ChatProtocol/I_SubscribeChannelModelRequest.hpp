...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_I_SUBSCRIBECHANNELMODEL_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_I_SUBSCRIBECHANNELMODEL_REQUEST_HPP_INCLUDED
...
class CHATPROTOCOL_DLL_LINK I_SubscribeChannelModelRequest
...
public:
    ...
    /// @{
protected:
             I_SubscribeChannelModelRequest();
    virtual ~I_SubscribeChannelModelRequest();
    /// @}

};  // interface I_SubscribeChannelModelRequest
...
namespace Zen {
namespace Memory {
    // I_SubscribeChannelModelRequest is managed by factory
    template<>
    struct is_managed_by_factory<Zen::Community::Protocol::I_SubscribeChannelModelRequest> : public boost::true_type{};
}   // namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_COMMUNITY_PROTOCOL_I_SUBSCRIBECHANNELMODEL_REQUEST_HPP_INCLUDED
