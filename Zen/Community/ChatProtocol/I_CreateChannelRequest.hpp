...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_I_CREATECHANNEL_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_I_CREATECHANNEL_REQUEST_HPP_INCLUDED
...
class CHATPROTOCOL_DLL_LINK I_CreateChannelRequest
...
public:
    ...
    /// @{
protected:
             I_CreateChannelRequest();
    virtual ~I_CreateChannelRequest();
    /// @}

};  // interface I_CreateChannelRequest
...
namespace Zen {
namespace Memory {
    // I_CreateChannelRequest is managed by factory
    template<>
    struct is_managed_by_factory<Zen::Community::Protocol::I_CreateChannelRequest> : public boost::true_type{};
}   // namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_COMMUNITY_PROTOCOL_I_CREATECHANNEL_REQUEST_HPP_INCLUDED
