...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_SESSION_I_ACCOUNT_DOMAIN_OBJECT_HPP_INCLUDED
#define ZEN_COMMUNITY_SESSION_I_ACCOUNT_DOMAIN_OBJECT_HPP_INCLUDED
...
class SESSIONMODEL_DLL_LINK I_AccountDomainObject
...
namespace Memory {
    ...
    template<>
    struct is_managed_by_factory<Zen::Community::Session::I_AccountDomainObject> : public boost::true_type{};
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
}   // namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_COMMUNITY_SESSION_I_ACCOUNT_DOMAIN_OBJECT_HPP_INCLUDED
