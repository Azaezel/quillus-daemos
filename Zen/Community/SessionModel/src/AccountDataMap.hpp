...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_SESSION_ACCOUNT_DATA_MAP_HPP_INCLUDED
#define ZEN_COMMUNITY_SESSION_ACCOUNT_DATA_MAP_HPP_INCLUDED
...
#endif // ZEN_COMMUNITY_SESSION_ACCOUNT_DATA_MAP_HPP_INCLUDED
