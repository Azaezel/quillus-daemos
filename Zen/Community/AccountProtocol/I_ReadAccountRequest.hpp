...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNT_PROTOCOL_I_READACCOUNT_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNT_PROTOCOL_I_READACCOUNT_REQUEST_HPP_INCLUDED
...
class ACCOUNTPROTOCOL_DLL_LINK I_ReadAccountRequest
...
public:
    ...
    /// @{
protected:
             I_ReadAccountRequest();
    virtual ~I_ReadAccountRequest();
    /// @}

};  // interface I_ReadAccountRequest
...
namespace Zen {
namespace Memory {
    // I_ReadAccountRequest is managed by factory
    template<>
    struct is_managed_by_factory<Zen::Community::Account::Protocol::I_ReadAccountRequest> : public boost::true_type{};
}   // namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_COMMUNITY_ACCOUNT_PROTOCOL_I_READACCOUNT_REQUEST_HPP_INCLUDED
