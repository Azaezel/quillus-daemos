...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_I_SUBSCRIBEACCOUNTMODEL_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_I_SUBSCRIBEACCOUNTMODEL_REQUEST_HPP_INCLUDED
...
namespace Memory {
    ...
    template<>
    struct is_managed_by_factory<Zen::Community::Protocol::I_SubscribeAccountModelRequest> : public boost::true_type{};
}   // namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_COMMUNITY_PROTOCOL_I_SUBSCRIBEACCOUNTMODEL_REQUEST_HPP_INCLUDED
