...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNT_PROTOCOL_I_UPDATEACCOUNT_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNT_PROTOCOL_I_UPDATEACCOUNT_REQUEST_HPP_INCLUDED
...
class ACCOUNTPROTOCOL_DLL_LINK I_UpdateAccountRequest
...
public:
    ...
    /// @{
protected:
             I_UpdateAccountRequest();
    virtual ~I_UpdateAccountRequest();
    /// @}

};  // interface I_UpdateAccountRequest
...
namespace Zen {
namespace Memory {
    // I_UpdateAccountRequest is managed by factory
    template<>
    struct is_managed_by_factory<Zen::Community::Account::Protocol::I_UpdateAccountRequest> : public boost::true_type{};
}   // namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_COMMUNITY_ACCOUNT_PROTOCOL_I_UPDATEACCOUNT_REQUEST_HPP_INCLUDED
