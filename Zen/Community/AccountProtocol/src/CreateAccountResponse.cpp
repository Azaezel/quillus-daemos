...
namespace Protocol {
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
CreateAccountResponse::pMessageType_type CreateAccountResponse::sm_pType;
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
Zen::Enterprise::AppServer::I_MessageRegistry* CreateAccountResponse::sm_pMessageRegistry = NULL;
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
CreateAccountResponse::CreateAccountResponse(pEndpoint_type _pSourceEndpoint,
                           pEndpoint_type _pDestinationEndpoint, boost::uint64_t _requestMessageId)
:   Response(CreateAccountResponse::createMessageHeader(getNewMessageId(), _requestMessageId), _pSourceEndpoint, _pDestinationEndpoint)        
{
}

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
CreateAccountResponse::CreateAccountResponse(pMessageHeader_type _pMessageHeader,
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
CreateAccountResponse::serialize(pMessageHeader_type _pHeader, boost::archive::polymorphic_iarchive& _archive, const int _version)
{
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
CreateAccountResponse::serialize(boost::archive::polymorphic_oarchive& _archive, const int _version)
{
    _archive & m_accountId;
}
...
CreateAccountResponse::getAccountId() const
{
    return m_accountId;
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
CreateAccountResponse::setAccountId(const boost::uint64_t& _accountId)
{
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
CreateAccountResponse::registerMessage(Zen::Enterprise::AppServer::I_ApplicationServer& _appServer)
{
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
CreateAccountResponse::destroy(wpResponse_type _wpResponse)
{
    CreateAccountResponse* pResponse = dynamic_cast<CreateAccountResponse*>(_wpResponse.get());
    ...
    {
        throw Zen::Utility::runtime_exception("CreateAccountResponse::destroy() : Invalid type.");
    }
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
CreateAccountResponse::pResourceLocation_type
CreateAccountResponse::getDestinationLocation()
{
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
CreateAccountResponse::pMessageType_type
CreateAccountResponse::getStaticMessageType()
{
    return sm_pType;
}
