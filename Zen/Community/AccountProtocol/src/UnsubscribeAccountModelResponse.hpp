...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNT_PROTOCOL_UNSUBSCRIBEACCOUNTMODEL_RESPONSE_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNT_PROTOCOL_UNSUBSCRIBEACCOUNTMODEL_RESPONSE_HPP_INCLUDED

#include "../I_UnsubscribeAccountModelResponse.hpp"
...
namespace Protocol {
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
class UnsubscribeAccountModelResponse
:   public I_UnsubscribeAccountModelResponse
,   public Response
{
    /// @name Types
    /// @{
public:
    enum { type = 204 };  // TODO Should we be hardcoding this?
...
public:
    ...
    /// @{
protected:
    friend class I_UnsubscribeAccountModelResponse;
    friend class MessageFactory;
             /// This constructor is used by the static create
             /// methods for creating outbound messages.
             UnsubscribeAccountModelResponse(pEndpoint_type _pSourceEndpoint,
             ...
             UnsubscribeAccountModelResponse(pMessageHeader_type _pMessageHeader,
                           pEndpoint_type _pSourceEndpoint,
                           pEndpoint_type _pDestinationEndpoint);
    virtual ~UnsubscribeAccountModelResponse();
    /// @}
...
#endif // ZEN_COMMUNITY_ACCOUNT_PROTOCOL_UNSUBSCRIBEACCOUNTMODEL_RESPONSE_HPP_INCLUDED
