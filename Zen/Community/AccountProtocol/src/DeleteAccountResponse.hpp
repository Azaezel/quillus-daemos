...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNT_PROTOCOL_DELETEACCOUNT_RESPONSE_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNT_PROTOCOL_DELETEACCOUNT_RESPONSE_HPP_INCLUDED

#include "../I_DeleteAccountResponse.hpp"
...
:   public I_DeleteAccountResponse
,   public Response
{
    /// @name Types
    /// @{
public:
    enum { type = 216 };  // TODO Should we be hardcoding this?
...
public:
    ...
    /// @{
protected:
    friend class I_DeleteAccountResponse;
    friend class MessageFactory;
             /// This constructor is used by the static create
             /// methods for creating outbound messages.
             DeleteAccountResponse(pEndpoint_type _pSourceEndpoint,
             ...
             DeleteAccountResponse(pMessageHeader_type _pMessageHeader,
...
#endif // ZEN_COMMUNITY_ACCOUNT_PROTOCOL_DELETEACCOUNT_RESPONSE_HPP_INCLUDED
