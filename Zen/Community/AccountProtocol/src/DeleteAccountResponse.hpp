...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_DELETEACCOUNT_RESPONSE_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_DELETEACCOUNT_RESPONSE_HPP_INCLUDED
...
#endif // ZEN_COMMUNITY_PROTOCOL_DELETEACCOUNT_RESPONSE_HPP_INCLUDED
