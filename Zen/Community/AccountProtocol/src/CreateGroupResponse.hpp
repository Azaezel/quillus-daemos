...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNT_PROTOCOL_CREATEGROUP_RESPONSE_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNT_PROTOCOL_CREATEGROUP_RESPONSE_HPP_INCLUDED

#include "../I_CreateGroupResponse.hpp"
...
:   public I_CreateGroupResponse
,   public Response
{
    /// @name Types
    /// @{
public:
    enum { type = 218 };  // TODO Should we be hardcoding this?
...
protected:
    ...
    friend class MessageFactory;
             ...
             CreateGroupResponse(pMessageHeader_type _pMessageHeader,
...
#endif // ZEN_COMMUNITY_ACCOUNT_PROTOCOL_CREATEGROUP_RESPONSE_HPP_INCLUDED
