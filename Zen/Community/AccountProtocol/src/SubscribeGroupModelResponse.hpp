...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_SUBSCRIBEGROUPMODEL_RESPONSE_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_SUBSCRIBEGROUPMODEL_RESPONSE_HPP_INCLUDED
...
#endif // ZEN_COMMUNITY_PROTOCOL_SUBSCRIBEGROUPMODEL_RESPONSE_HPP_INCLUDED
