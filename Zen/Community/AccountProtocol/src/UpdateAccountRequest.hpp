...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNT_PROTOCOL_UPDATEACCOUNT_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNT_PROTOCOL_UPDATEACCOUNT_REQUEST_HPP_INCLUDED

#include "../I_UpdateAccountRequest.hpp"
...
:   public I_UpdateAccountRequest
,   public Request
{
    /// @name Types
    /// @{
public:
    enum { type = 213 };  // TODO Should we be hardcoding this?
...
#endif // ZEN_COMMUNITY_ACCOUNT_PROTOCOL_UPDATEACCOUNT_REQUEST_HPP_INCLUDED
