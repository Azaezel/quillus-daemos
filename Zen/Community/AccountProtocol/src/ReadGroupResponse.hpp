...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNT_PROTOCOL_READGROUP_RESPONSE_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNT_PROTOCOL_READGROUP_RESPONSE_HPP_INCLUDED

#include "../I_ReadGroupResponse.hpp"
...
:   public I_ReadGroupResponse
,   public Response
{
    /// @name Types
    /// @{
public:
    enum { type = 220 };  // TODO Should we be hardcoding this?
...
protected:
    ...
    friend class MessageFactory;
             ...
             ReadGroupResponse(pMessageHeader_type _pMessageHeader,
                           pEndpoint_type _pSourceEndpoint,
                           pEndpoint_type _pDestinationEndpoint);
    virtual ~ReadGroupResponse();
    /// @}
...
#endif // ZEN_COMMUNITY_ACCOUNT_PROTOCOL_READGROUP_RESPONSE_HPP_INCLUDED
