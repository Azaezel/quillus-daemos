...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNT_PROTOCOL_DELETEGROUP_RESPONSE_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNT_PROTOCOL_DELETEGROUP_RESPONSE_HPP_INCLUDED

#include "../I_DeleteGroupResponse.hpp"
...
:   public I_DeleteGroupResponse
,   public Response
{
    /// @name Types
    /// @{
public:
    enum { type = 224 };  // TODO Should we be hardcoding this?
...
protected:
    ...
    friend class MessageFactory;
             ...
             DeleteGroupResponse(pMessageHeader_type _pMessageHeader,
...
#endif // ZEN_COMMUNITY_ACCOUNT_PROTOCOL_DELETEGROUP_RESPONSE_HPP_INCLUDED
