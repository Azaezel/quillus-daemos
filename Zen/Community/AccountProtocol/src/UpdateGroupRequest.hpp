...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNT_PROTOCOL_UPDATEGROUP_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNT_PROTOCOL_UPDATEGROUP_REQUEST_HPP_INCLUDED

#include "../I_UpdateGroupRequest.hpp"
...
:   public I_UpdateGroupRequest
,   public Request
{
    /// @name Types
    /// @{
public:
    enum { type = 221 };  // TODO Should we be hardcoding this?
...
#endif // ZEN_COMMUNITY_ACCOUNT_PROTOCOL_UPDATEGROUP_REQUEST_HPP_INCLUDED
