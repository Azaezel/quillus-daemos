...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNT_PROTOCOL_CREATEACCOUNT_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNT_PROTOCOL_CREATEACCOUNT_REQUEST_HPP_INCLUDED

#include "../I_CreateAccountRequest.hpp"
...
:   public I_CreateAccountRequest
,   public Request
{
    /// @name Types
    /// @{
public:
    enum { type = 209 };  // TODO Should we be hardcoding this?
...
#endif // ZEN_COMMUNITY_ACCOUNT_PROTOCOL_CREATEACCOUNT_REQUEST_HPP_INCLUDED
