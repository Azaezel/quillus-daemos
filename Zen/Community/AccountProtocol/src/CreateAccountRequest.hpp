...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_CREATEACCOUNT_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_CREATEACCOUNT_REQUEST_HPP_INCLUDED
...
#endif // ZEN_COMMUNITY_PROTOCOL_CREATEACCOUNT_REQUEST_HPP_INCLUDED
