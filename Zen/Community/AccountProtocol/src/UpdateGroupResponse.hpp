...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNT_PROTOCOL_UPDATEGROUP_RESPONSE_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNT_PROTOCOL_UPDATEGROUP_RESPONSE_HPP_INCLUDED

#include "../I_UpdateGroupResponse.hpp"
...
:   public I_UpdateGroupResponse
,   public Response
{
    /// @name Types
    /// @{
public:
    enum { type = 222 };  // TODO Should we be hardcoding this?
...
protected:
    ...
    friend class MessageFactory;
             ...
             UpdateGroupResponse(pMessageHeader_type _pMessageHeader,
...
#endif // ZEN_COMMUNITY_ACCOUNT_PROTOCOL_UPDATEGROUP_RESPONSE_HPP_INCLUDED
