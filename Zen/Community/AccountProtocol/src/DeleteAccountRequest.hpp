...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNT_PROTOCOL_DELETEACCOUNT_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNT_PROTOCOL_DELETEACCOUNT_REQUEST_HPP_INCLUDED

#include "../I_DeleteAccountRequest.hpp"
...
:   public I_DeleteAccountRequest
,   public Request
{
    /// @name Types
    /// @{
public:
    enum { type = 215 };  // TODO Should we be hardcoding this?
...
#endif // ZEN_COMMUNITY_ACCOUNT_PROTOCOL_DELETEACCOUNT_REQUEST_HPP_INCLUDED
