...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_ACCOUNTMODELUPDATE_MESSAGE_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_ACCOUNTMODELUPDATE_MESSAGE_HPP_INCLUDED
...
#endif // ZEN_COMMUNITY_PROTOCOL_ACCOUNTMODELUPDATE_MESSAGE_HPP_INCLUDED
