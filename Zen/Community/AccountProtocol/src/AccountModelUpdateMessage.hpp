...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNT_PROTOCOL_ACCOUNTMODELUPDATE_MESSAGE_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNT_PROTOCOL_ACCOUNTMODELUPDATE_MESSAGE_HPP_INCLUDED

#include "../I_AccountModelUpdateMessage.hpp"
...
namespace Protocol {
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
class AccountModelUpdateMessage
:   public I_AccountModelUpdateMessage
,   public Message
{
    /// @name Types
    /// @{
public:
    enum { type = 225 };  // TODO Should we be hardcoding this?
...
public:
    ...
    virtual const I_AccountModelUpdateMessage::UpdateKind_type& getUpdateKind() const;
    
    /// Set the updateKind element value.
    virtual void setUpdateKind(const I_AccountModelUpdateMessage::UpdateKind_type& _updateKind);
    ...
    virtual const boost::uint64_t& getAccountId() const;
    
    /// Set the accountId element value.
    virtual void setAccountId(const boost::uint64_t& _accountId);
    /// @}
...
#endif // ZEN_COMMUNITY_ACCOUNT_PROTOCOL_ACCOUNTMODELUPDATE_MESSAGE_HPP_INCLUDED
