...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNT_PROTOCOL_MESSAGE_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNT_PROTOCOL_MESSAGE_HPP_INCLUDED
...
class Message
:   public Zen::Community::Account::Protocol::I_Message
{
    /// @name Types
    /// @{
public:
...
#endif // ZEN_COMMUNITY_ACCOUNT_PROTOCOL_MESSAGE_HPP_INCLUDED
