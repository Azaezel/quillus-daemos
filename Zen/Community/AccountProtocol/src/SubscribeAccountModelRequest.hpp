...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNT_PROTOCOL_SUBSCRIBEACCOUNTMODEL_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNT_PROTOCOL_SUBSCRIBEACCOUNTMODEL_REQUEST_HPP_INCLUDED

#include "../I_SubscribeAccountModelRequest.hpp"
...
namespace Protocol {
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
class SubscribeAccountModelRequest
:   public I_SubscribeAccountModelRequest
,   public Request
{
    /// @name Types
    /// @{
...
public:
    ...
    /// @{
protected:
    friend class I_SubscribeAccountModelRequest;
    friend class MessageFactory;
             /// This constructor is used by the static create
             /// methods for creating outbound messages.
             SubscribeAccountModelRequest(pEndpoint_type _pSourceEndpoint,
                           pEndpoint_type _pDestinationEndpoint);
             /// This constructor is used by the message factory
             /// for creating inbound messages.
             SubscribeAccountModelRequest(pMessageHeader_type _pMessageHeader,
                           pEndpoint_type _pSourceEndpoint,
                           pEndpoint_type _pDestinationEndpoint);
    virtual ~SubscribeAccountModelRequest();
    /// @}
...
#endif // ZEN_COMMUNITY_ACCOUNT_PROTOCOL_SUBSCRIBEACCOUNTMODEL_REQUEST_HPP_INCLUDED
