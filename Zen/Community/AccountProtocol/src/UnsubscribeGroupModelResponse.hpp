...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNT_PROTOCOL_UNSUBSCRIBEGROUPMODEL_RESPONSE_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNT_PROTOCOL_UNSUBSCRIBEGROUPMODEL_RESPONSE_HPP_INCLUDED

#include "../I_UnsubscribeGroupModelResponse.hpp"
...
namespace Protocol {
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
class UnsubscribeGroupModelResponse
:   public I_UnsubscribeGroupModelResponse
,   public Response
{
    /// @name Types
    /// @{
public:
    enum { type = 208 };  // TODO Should we be hardcoding this?
...
public:
    ...
    /// @{
protected:
    friend class I_UnsubscribeGroupModelResponse;
    friend class MessageFactory;
             /// This constructor is used by the static create
             /// methods for creating outbound messages.
             UnsubscribeGroupModelResponse(pEndpoint_type _pSourceEndpoint,
             ...
             UnsubscribeGroupModelResponse(pMessageHeader_type _pMessageHeader,
                           pEndpoint_type _pSourceEndpoint,
                           pEndpoint_type _pDestinationEndpoint);
    virtual ~UnsubscribeGroupModelResponse();
    /// @}
...
#endif // ZEN_COMMUNITY_ACCOUNT_PROTOCOL_UNSUBSCRIBEGROUPMODEL_RESPONSE_HPP_INCLUDED
