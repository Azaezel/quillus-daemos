...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNT_PROTOCOL_GROUPMODELUPDATE_MESSAGE_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNT_PROTOCOL_GROUPMODELUPDATE_MESSAGE_HPP_INCLUDED

#include "../I_GroupModelUpdateMessage.hpp"
...
namespace Protocol {
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
class GroupModelUpdateMessage
:   public I_GroupModelUpdateMessage
,   public Message
{
    /// @name Types
    /// @{
public:
    enum { type = 226 };  // TODO Should we be hardcoding this?
...
public:
    ...
    virtual const I_GroupModelUpdateMessage::UpdateKind_type& getUpdateKind() const;
    
    /// Set the updateKind element value.
    virtual void setUpdateKind(const I_GroupModelUpdateMessage::UpdateKind_type& _updateKind);

    /// Get the groupId element.
    virtual const boost::uint64_t& getGroupId() const;
    
    /// Set the groupId element value.
    virtual void setGroupId(const boost::uint64_t& _groupId);
    ...
    virtual const std::string& getGroupDescription() const;
    
    /// Set the groupDescription element value.
    virtual void setGroupDescription(const std::string& _groupDescription);
    /// @}
...
#endif // ZEN_COMMUNITY_ACCOUNT_PROTOCOL_GROUPMODELUPDATE_MESSAGE_HPP_INCLUDED
