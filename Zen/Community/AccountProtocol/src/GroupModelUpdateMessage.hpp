...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_GROUPMODELUPDATE_MESSAGE_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_GROUPMODELUPDATE_MESSAGE_HPP_INCLUDED
...
#endif // ZEN_COMMUNITY_PROTOCOL_GROUPMODELUPDATE_MESSAGE_HPP_INCLUDED
