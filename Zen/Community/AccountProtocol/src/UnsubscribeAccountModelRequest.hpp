...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNT_PROTOCOL_UNSUBSCRIBEACCOUNTMODEL_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNT_PROTOCOL_UNSUBSCRIBEACCOUNTMODEL_REQUEST_HPP_INCLUDED

#include "../I_UnsubscribeAccountModelRequest.hpp"
...
namespace Protocol {
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
class UnsubscribeAccountModelRequest
:   public I_UnsubscribeAccountModelRequest
,   public Request
{
    /// @name Types
    /// @{
public:
    enum { type = 203 };  // TODO Should we be hardcoding this?
...
public:
    ...
    /// @{
protected:
    friend class I_UnsubscribeAccountModelRequest;
    friend class MessageFactory;
             /// This constructor is used by the static create
             /// methods for creating outbound messages.
             UnsubscribeAccountModelRequest(pEndpoint_type _pSourceEndpoint,
                           pEndpoint_type _pDestinationEndpoint);
             /// This constructor is used by the message factory
             /// for creating inbound messages.
             UnsubscribeAccountModelRequest(pMessageHeader_type _pMessageHeader,
                           pEndpoint_type _pSourceEndpoint,
                           pEndpoint_type _pDestinationEndpoint);
    virtual ~UnsubscribeAccountModelRequest();
    /// @}
...
#endif // ZEN_COMMUNITY_ACCOUNT_PROTOCOL_UNSUBSCRIBEACCOUNTMODEL_REQUEST_HPP_INCLUDED
