...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNT_PROTOCOL_READACCOUNT_RESPONSE_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNT_PROTOCOL_READACCOUNT_RESPONSE_HPP_INCLUDED

#include "../I_ReadAccountResponse.hpp"
...
:   public I_ReadAccountResponse
,   public Response
{
    /// @name Types
    /// @{
public:
    enum { type = 212 };  // TODO Should we be hardcoding this?
...
protected:
    ...
    friend class MessageFactory;
             ...
             ReadAccountResponse(pMessageHeader_type _pMessageHeader,
                           pEndpoint_type _pSourceEndpoint,
                           pEndpoint_type _pDestinationEndpoint);
    virtual ~ReadAccountResponse();
    /// @}
...
#endif // ZEN_COMMUNITY_ACCOUNT_PROTOCOL_READACCOUNT_RESPONSE_HPP_INCLUDED
