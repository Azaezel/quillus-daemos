...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_READACCOUNT_RESPONSE_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_READACCOUNT_RESPONSE_HPP_INCLUDED
...
#endif // ZEN_COMMUNITY_PROTOCOL_READACCOUNT_RESPONSE_HPP_INCLUDED
