...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_CREATEGROUP_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_CREATEGROUP_REQUEST_HPP_INCLUDED
...
#endif // ZEN_COMMUNITY_PROTOCOL_CREATEGROUP_REQUEST_HPP_INCLUDED
