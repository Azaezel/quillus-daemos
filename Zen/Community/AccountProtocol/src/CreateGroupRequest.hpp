...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNT_PROTOCOL_CREATEGROUP_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNT_PROTOCOL_CREATEGROUP_REQUEST_HPP_INCLUDED

#include "../I_CreateGroupRequest.hpp"
...
:   public I_CreateGroupRequest
,   public Request
{
    /// @name Types
    /// @{
public:
    enum { type = 217 };  // TODO Should we be hardcoding this?
...
#endif // ZEN_COMMUNITY_ACCOUNT_PROTOCOL_CREATEGROUP_REQUEST_HPP_INCLUDED
