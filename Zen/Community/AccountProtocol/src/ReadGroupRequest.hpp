...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNT_PROTOCOL_READGROUP_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNT_PROTOCOL_READGROUP_REQUEST_HPP_INCLUDED

#include "../I_ReadGroupRequest.hpp"
...
:   public I_ReadGroupRequest
,   public Request
{
    /// @name Types
    /// @{
public:
    enum { type = 219 };  // TODO Should we be hardcoding this?
...
#endif // ZEN_COMMUNITY_ACCOUNT_PROTOCOL_READGROUP_REQUEST_HPP_INCLUDED
