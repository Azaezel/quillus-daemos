...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNT_PROTOCOL_SUBSCRIBEGROUPMODEL_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNT_PROTOCOL_SUBSCRIBEGROUPMODEL_REQUEST_HPP_INCLUDED

#include "../I_SubscribeGroupModelRequest.hpp"
...
namespace Protocol {
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
class SubscribeGroupModelRequest
:   public I_SubscribeGroupModelRequest
,   public Request
{
    /// @name Types
    /// @{
public:
    enum { type = 205 };  // TODO Should we be hardcoding this?
...
#endif // ZEN_COMMUNITY_ACCOUNT_PROTOCOL_SUBSCRIBEGROUPMODEL_REQUEST_HPP_INCLUDED
