...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNT_PROTOCOL_CREATEACCOUNT_RESPONSE_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNT_PROTOCOL_CREATEACCOUNT_RESPONSE_HPP_INCLUDED

#include "../I_CreateAccountResponse.hpp"
...
:   public I_CreateAccountResponse
,   public Response
{
    /// @name Types
    /// @{
public:
    enum { type = 210 };  // TODO Should we be hardcoding this?
...
public:
    ...
    /// @{
protected:
    friend class I_CreateAccountResponse;
    friend class MessageFactory;
             /// This constructor is used by the static create
             /// methods for creating outbound messages.
             CreateAccountResponse(pEndpoint_type _pSourceEndpoint,
             ...
             CreateAccountResponse(pMessageHeader_type _pMessageHeader,
...
#endif // ZEN_COMMUNITY_ACCOUNT_PROTOCOL_CREATEACCOUNT_RESPONSE_HPP_INCLUDED
