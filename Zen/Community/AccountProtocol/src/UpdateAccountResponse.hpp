...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNT_PROTOCOL_UPDATEACCOUNT_RESPONSE_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNT_PROTOCOL_UPDATEACCOUNT_RESPONSE_HPP_INCLUDED

#include "../I_UpdateAccountResponse.hpp"
...
:   public I_UpdateAccountResponse
,   public Response
{
    /// @name Types
    /// @{
public:
    enum { type = 214 };  // TODO Should we be hardcoding this?
...
public:
    ...
    /// @{
protected:
    friend class I_UpdateAccountResponse;
    friend class MessageFactory;
             /// This constructor is used by the static create
             /// methods for creating outbound messages.
             UpdateAccountResponse(pEndpoint_type _pSourceEndpoint,
             ...
             UpdateAccountResponse(pMessageHeader_type _pMessageHeader,
...
#endif // ZEN_COMMUNITY_ACCOUNT_PROTOCOL_UPDATEACCOUNT_RESPONSE_HPP_INCLUDED
