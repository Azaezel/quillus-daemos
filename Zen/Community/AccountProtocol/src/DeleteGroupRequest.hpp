...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNT_PROTOCOL_DELETEGROUP_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNT_PROTOCOL_DELETEGROUP_REQUEST_HPP_INCLUDED

#include "../I_DeleteGroupRequest.hpp"
...
:   public I_DeleteGroupRequest
,   public Request
{
    /// @name Types
    /// @{
public:
    enum { type = 223 };  // TODO Should we be hardcoding this?
...
#endif // ZEN_COMMUNITY_ACCOUNT_PROTOCOL_DELETEGROUP_REQUEST_HPP_INCLUDED
