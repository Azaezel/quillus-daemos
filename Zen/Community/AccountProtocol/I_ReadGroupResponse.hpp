...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNT_PROTOCOL_I_READGROUP_RESPONSE_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNT_PROTOCOL_I_READGROUP_RESPONSE_HPP_INCLUDED
...
class ACCOUNTPROTOCOL_DLL_LINK I_ReadGroupResponse
...
protected:
             I_ReadGroupResponse();
    virtual ~I_ReadGroupResponse();
    /// @}

};  // interface I_ReadGroupResponse
...
namespace Zen {
namespace Memory {
    // I_ReadGroupResponse is managed by factory
    template<>
    struct is_managed_by_factory<Zen::Community::Account::Protocol::I_ReadGroupResponse> : public boost::true_type{};
}   // namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_COMMUNITY_ACCOUNT_PROTOCOL_I_READGROUP_RESPONSE_HPP_INCLUDED
