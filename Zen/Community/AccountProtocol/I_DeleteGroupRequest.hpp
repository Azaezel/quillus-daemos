...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNT_PROTOCOL_I_DELETEGROUP_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNT_PROTOCOL_I_DELETEGROUP_REQUEST_HPP_INCLUDED
...
class ACCOUNTPROTOCOL_DLL_LINK I_DeleteGroupRequest
...
public:
    ...
    /// @{
protected:
             I_DeleteGroupRequest();
    virtual ~I_DeleteGroupRequest();
    /// @}

};  // interface I_DeleteGroupRequest
...
namespace Zen {
namespace Memory {
    // I_DeleteGroupRequest is managed by factory
    template<>
    struct is_managed_by_factory<Zen::Community::Account::Protocol::I_DeleteGroupRequest> : public boost::true_type{};
}   // namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_COMMUNITY_ACCOUNT_PROTOCOL_I_DELETEGROUP_REQUEST_HPP_INCLUDED
