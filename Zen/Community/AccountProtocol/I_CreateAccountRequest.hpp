...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNT_PROTOCOL_I_CREATEACCOUNT_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNT_PROTOCOL_I_CREATEACCOUNT_REQUEST_HPP_INCLUDED
...
class ACCOUNTPROTOCOL_DLL_LINK I_CreateAccountRequest
...
protected:
    ...
    virtual ~I_CreateAccountRequest();
    /// @}

};  // interface I_CreateAccountRequest
...
namespace Zen {
namespace Memory {
    // I_CreateAccountRequest is managed by factory
    template<>
    struct is_managed_by_factory<Zen::Community::Account::Protocol::I_CreateAccountRequest> : public boost::true_type{};
}   // namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_COMMUNITY_ACCOUNT_PROTOCOL_I_CREATEACCOUNT_REQUEST_HPP_INCLUDED
