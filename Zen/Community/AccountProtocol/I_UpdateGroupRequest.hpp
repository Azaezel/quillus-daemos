...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNT_PROTOCOL_I_UPDATEGROUP_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNT_PROTOCOL_I_UPDATEGROUP_REQUEST_HPP_INCLUDED
...
class ACCOUNTPROTOCOL_DLL_LINK I_UpdateGroupRequest
...
public:
    ...
    /// @{
protected:
             I_UpdateGroupRequest();
    virtual ~I_UpdateGroupRequest();
    /// @}

};  // interface I_UpdateGroupRequest
...
namespace Zen {
namespace Memory {
    // I_UpdateGroupRequest is managed by factory
    template<>
    struct is_managed_by_factory<Zen::Community::Account::Protocol::I_UpdateGroupRequest> : public boost::true_type{};
}   // namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_COMMUNITY_ACCOUNT_PROTOCOL_I_UPDATEGROUP_REQUEST_HPP_INCLUDED
