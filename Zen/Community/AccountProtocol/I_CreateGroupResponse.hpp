...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_I_CREATEGROUP_RESPONSE_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_I_CREATEGROUP_RESPONSE_HPP_INCLUDED
...
namespace Memory {
    ...
    template<>
    struct is_managed_by_factory<Zen::Community::Protocol::I_CreateGroupResponse> : public boost::true_type{};
}   // namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_COMMUNITY_PROTOCOL_I_CREATEGROUP_RESPONSE_HPP_INCLUDED
