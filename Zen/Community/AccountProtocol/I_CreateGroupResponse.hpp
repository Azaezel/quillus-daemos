...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNT_PROTOCOL_I_CREATEGROUP_RESPONSE_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNT_PROTOCOL_I_CREATEGROUP_RESPONSE_HPP_INCLUDED
...
class ACCOUNTPROTOCOL_DLL_LINK I_CreateGroupResponse
...
public:
    ...
    /// @{
protected:
             I_CreateGroupResponse();
    virtual ~I_CreateGroupResponse();
    /// @}

};  // interface I_CreateGroupResponse
...
namespace Zen {
namespace Memory {
    // I_CreateGroupResponse is managed by factory
    template<>
    struct is_managed_by_factory<Zen::Community::Account::Protocol::I_CreateGroupResponse> : public boost::true_type{};
}   // namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_COMMUNITY_ACCOUNT_PROTOCOL_I_CREATEGROUP_RESPONSE_HPP_INCLUDED
