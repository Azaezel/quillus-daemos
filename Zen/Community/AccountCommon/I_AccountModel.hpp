...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNTCOMMON_ACCOUNT_MODEL_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNTCOMMON_ACCOUNT_MODEL_HPP_INCLUDED
...
class ACCOUNTCOMMON_DLL_LINK I_AccountModel
:   boost::noncopyable
{
    /// @name Types
    /// @{
public:
    typedef Memory::managed_ptr<I_AccountView>                          pAccountView_type;
...
public:
    ...
    virtual pFutureSubscription_type subscribe(pEndpoint_type _pDestinationEndpoint, pAccountView_type _pView, pFilter_type _pFilter = pFilter_type()) = 0;

    virtual Event::I_Event& getAccountEvent() = 0;
    /// @}
...
protected:
             I_AccountModel();
    virtual ~I_AccountModel();
    /// @}

};  // interface I_AccountModel

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
}   // namespace Common
}   // namespace Community
namespace Memory {
	/// I_AccountModel is managed by factory
	template<>
	struct is_managed_by_factory<Community::Common::I_AccountModel> : public boost::true_type{};
}	// namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_COMMUNITY_ACCOUNTCOMMON_ACCOUNT_MODEL_HPP_INCLUDED
