...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNTCOMMON_GROUP_MODEL_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNTCOMMON_GROUP_MODEL_HPP_INCLUDED
...
class ACCOUNTCOMMON_DLL_LINK I_GroupModel
:   boost::noncopyable
{
    /// @name Types
    /// @{
public:
    typedef Memory::managed_ptr<I_GroupView>                            pGroupView_type;
...
public:
    ...
    virtual pFutureSubscription_type subscribe(pEndpoint_type _pDestinationEndpoint, pGroupView_type _pView, pFilter_type _pFilter = pFilter_type()) = 0;
...
protected:
             I_GroupModel();
    virtual ~I_GroupModel();
    /// @}

};  // interface I_GroupModel

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
}   // namespace Common
}   // namespace Community
namespace Memory {
	/// I_GroupModel is managed by factory
	template<>
	struct is_managed_by_factory<Community::Common::I_GroupModel> : public boost::true_type{};
}	// namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_COMMUNITY_ACCOUNTCOMMON_GROUP_MODEL_HPP_INCLUDED
