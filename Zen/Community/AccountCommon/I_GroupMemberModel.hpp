...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNTCOMMON_GROUP_MEMBER_MODEL_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNTCOMMON_GROUP_MEMBER_MODEL_HPP_INCLUDED
...
namespace Common {
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
class I_GroupMemberView;

class ACCOUNTCOMMON_DLL_LINK I_GroupMemberModel
:   boost::noncopyable
{
    /// @name Types
    /// @{
public:
    typedef I_GroupMemberView*                                          pGroupMemberView_type;
    ...
    /// @name I_GroupMemberModel interface
    /// @{
public:
    ...
    virtual pSubscription_type subscribe(pGroupMemberView_type _pView, pFilter_type _pFilter = pFilter_type()) = 0;

    virtual Event::I_Event& getGroupEvent() = 0;
    /// @}
...
protected:
             I_GroupMemberModel();
    virtual ~I_GroupMemberModel();
    /// @}

};  // interface I_GroupMemberModel

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
}   // namespace Common
}   // namespace Community
namespace Memory {
	/// I_GroupMemberModel is managed by factory
	template<>
	struct is_managed_by_factory<Community::Common::I_GroupMemberModel> : public boost::true_type{};
}	// namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_COMMUNITY_ACCOUNTCOMMON_GROUP_MEMBER_MODEL_HPP_INCLUDED
