...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_SESSIONSERVER_SESSION_SERVICE_FACTORY_HPP_INCLUDED
#define ZEN_COMMUNITY_SESSIONSERVER_SESSION_SERVICE_FACTORY_HPP_INCLUDED
...
#endif // ZEN_COMMUNITY_SESSIONSERVER_SESSION_SERVICE_FACTORY_HPP_INCLUDED
