...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_SESSIONPROTOCOL_I_MESSAGE_HPP_INCLUDED
#define ZEN_COMMUNITY_SESSIONPROTOCOL_I_MESSAGE_HPP_INCLUDED
...
{
    /// @name Community::I_Message interface
    /// @{
public:
...
namespace Memory {
    ...
    template<>
	struct is_managed_by_factory<Zen::Community::Protocol::I_Message> : public boost::true_type{};
}   // namespace Memory
}	// namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_COMMUNITY_SESSIONPROTOCOL_I_MESSAGE_HPP_INCLUDED
