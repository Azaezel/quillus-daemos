...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_SESSION_PROTOCOL_I_LOGIN_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_SESSION_PROTOCOL_I_LOGIN_REQUEST_HPP_INCLUDED
...
namespace Memory {
    ...
    template<>
    struct is_managed_by_factory<Zen::Community::Session::Protocol::I_LoginRequest> : public boost::true_type{};
}   // namespace Memory
}   // namespace Zen
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~

#endif // ZEN_COMMUNITY_SESSION_PROTOCOL_I_LOGIN_REQUEST_HPP_INCLUDED
