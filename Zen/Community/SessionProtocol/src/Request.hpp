...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_SESSION_PROTOCOL_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_SESSION_PROTOCOL_REQUEST_HPP_INCLUDED
...
#endif // ZEN_COMMUNITY_SESSION_PROTOCOL_REQUEST_HPP_INCLUDED
