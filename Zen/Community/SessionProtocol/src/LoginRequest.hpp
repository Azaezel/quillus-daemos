...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_SESSIONPROTOCOL_SESSION_REQUEST_HPP_INCLUDED
#define ZEN_COMMUNITY_SESSIONPROTOCOL_SESSION_REQUEST_HPP_INCLUDED

#include "../I_LoginRequest.hpp"
...
public:
    ...
    /// @name I_LoginRequest implementation
    /// @{
public:
...
public:
    friend class MessageFactory;
             ...
             LoginRequest(pEndpoint_type _pSourceEndpoint,
                          pEndpoint_type _pDestinationEndpoint);
             /// This constructor is used by the message factory
             /// for creating inbound messages.
             LoginRequest(pMessageHeader_type _pMessageHeader,
...
#endif // ZEN_COMMUNITY_SESSIONPROTOCOL_SESSION_REQUEST_HPP_INCLUDED
