...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_SESSION_PROTOCOL_LOGIN_RESPONSE_HPP_INCLUDED
#define ZEN_COMMUNITY_SESSION_PROTOCOL_LOGIN_RESPONSE_HPP_INCLUDED
...
#endif // ZEN_COMMUNITY_SESSION_PROTOCOL_LOGIN_RESPONSE_HPP_INCLUDED
