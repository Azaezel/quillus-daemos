...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_SESSIONPROTOCOL_RESPONSE_HPP_INCLUDED
#define ZEN_COMMUNITY_SESSIONPROTOCOL_RESPONSE_HPP_INCLUDED
...
,   public Message
{
    ...
    /// @{
public:
    enum { type = 2 };  // TODO Should we be hardcoding this?
...
public:
    ...
    /// @name I_LoginResponse implementation
    /// @{
public:
    virtual NumericResponse_type getResponse() const;
    virtual const std::string& getMessage() const;
    virtual boost::int32_t getSessionId() const;
    virtual Common::I_Session::SessionState_type getSessionState() const;
    /// @}

    /// @name LoginResponse implementation
    /// @{
public:
    ...
    void setSessionState(Common::I_Session::SessionState_type _sessionState);
    /// @}
...
private:
    ...
    /// Additional login message (if any)
    ...
    /// Session State
    Common::I_Session::SessionState_type    m_sessionState;
...
#endif // ZEN_COMMUNITY_SESSIONPROTOCOL_RESPONSE_HPP_INCLUDED
