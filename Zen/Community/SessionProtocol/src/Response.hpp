...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_SESSION_PROTOCOL_RESPONSE_HPP_INCLUDED
#define ZEN_COMMUNITY_SESSION_PROTOCOL_RESPONSE_HPP_INCLUDED
...
class Response
:   public Zen::Community::Session::Protocol::Message
...
#endif // ZEN_COMMUNITY_SESSION_PROTOCOL_RESPONSE_HPP_INCLUDED
