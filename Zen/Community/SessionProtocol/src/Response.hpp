...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_RESPONSE_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_RESPONSE_HPP_INCLUDED
...
class Response
:   public virtual Zen::Community::Protocol::Message
...
#endif // ZEN_COMMUNITY_PROTOCOL_RESPONSE_HPP_INCLUDED
