...
namespace Protocol {
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
I_LoginResponse::I_LoginResponse()
{
}
						...
						const std::string& _message)
{
    ...
    pLoginResponse->setRequestMessageId(_messageId);
    pLoginResponse->setResponse(_response);
    pLoginResponse->setMessage(_message);

    return pResponse_type(pLoginResponse, LoginResponse::destroy);
}
