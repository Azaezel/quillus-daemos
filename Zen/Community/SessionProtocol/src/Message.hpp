...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_SESSION_PROTOCOL_MESSAGE_HPP_INCLUDED
#define ZEN_COMMUNITY_SESSION_PROTOCOL_MESSAGE_HPP_INCLUDED
...
class Message
:   public Zen::Community::Session::Protocol::I_Message
{
    /// @name Types
    /// @{
public:
...
#endif // ZEN_COMMUNITY_SESSION_PROTOCOL_MESSAGE_HPP_INCLUDED
