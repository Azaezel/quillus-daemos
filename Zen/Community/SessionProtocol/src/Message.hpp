...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_SESSIONPROTOCOL_MESSAGE_HPP_INCLUDED
#define ZEN_COMMUNITY_SESSIONPROTOCOL_MESSAGE_HPP_INCLUDED
...
#endif // ZEN_COMMUNITY_SESSIONPROTOCOL_MESSAGE_HPP_INCLUDED
