...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_PROTOCOL_MESSAGE_FACTORY_HPP_INCLUDED
#define ZEN_COMMUNITY_PROTOCOL_MESSAGE_FACTORY_HPP_INCLUDED
...
#endif // ZEN_COMMUNITY_PROTOCOL_MESSAGE_FACTORY_HPP_INCLUDED
