...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
typedef Common::subscription<AccountModelProxy*, AccountModelProxy::pAccountView_type> Subscription;
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
static void
...
AccountModelProxy::subscribe(Common::I_Session& _session, pAccountView_type _pView, pFilter_type _pFilter)
{
    /// TODO make async
    ...
    Zen::Enterprise::AppServer::create_request<Protocol::I_SubscribeAccountModelRequest, ProxySubscription*>
        request(pDestinationEndpoint, pProxySubscription);
    
    request->setSessionId(_session.getSessionId());

    m_service.send<Protocol::I_SubscribeAccountModelRequest, ProxySubscription*>
...
AccountModelProxy::createAccount(Common::I_Session& _session, const std::string& _username, const std::string& _password)
{
    ...
    Zen::Enterprise::AppServer::create_request<Protocol::I_CreateAccountRequest, ProxyAccount*>
    ...
    // Send the request
    m_service.send<Protocol::I_CreateAccountRequest, ProxyAccount*>
...
AccountModelProxy::getAccount(Common::I_Session& _session, const std::string& _username)
{
    ...
    Zen::Enterprise::AppServer::create_request<Protocol::I_ReadAccountRequest, ProxyAccount*>
        request(pDestinationEndpoint, pProxyAccount);
    ...
    // Send the request
    m_service.send<Protocol::I_ReadAccountRequest, ProxyAccount*>
...
AccountModelProxy::updateAccount(Common::I_Session& _session, Common::I_Account& _account)
{
    ...
    // Create an account read request using ProxyAccount* as the payload.
    Zen::Enterprise::AppServer::create_request<Protocol::I_UpdateAccountRequest, ProxyAccount*>
        request(pDestinationEndpoint, pProxyAccount);
    ...
    // Send the request
    m_service.send<Protocol::I_UpdateAccountRequest, ProxyAccount*>
...
AccountModelProxy::removeAccount(Common::I_Session& _session, Common::I_Account& _account)
{
    ...
    // Create an account read request using ProxyAccount* as the payload.
    Zen::Enterprise::AppServer::create_request<Protocol::I_DeleteAccountRequest, ProxyAccount*>
        request(pDestinationEndpoint, pProxyAccount);
    ...
    // Send the request
    m_service.send<Protocol::I_DeleteAccountRequest, ProxyAccount*>
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
AccountModelProxy::unSubscribe(Common::I_Session& _session, pAccountView_type _pView)
{
    typedef Memory::managed_ptr<Zen::Networking::I_Endpoint>    pEndpoint_type;
    pEndpoint_type pDestinationEndpoint = _session.getEndpoint();

    // Create a subscription request using pFutureSubscription as the payload.
    Zen::Enterprise::AppServer::create_request<Protocol::I_UnsubscribeAccountModelRequest, pAccountView_type>
    ...
    m_service.send<Protocol::I_UnsubscribeAccountModelRequest, pAccountView_type>
...
AccountModelProxy::handleUpdateNotification(pMessage_type _pMessage)
{
    ...
    case Protocol::I_AccountModelUpdateMessage::ADD:
    ...
    case Protocol::I_AccountModelUpdateMessage::UPDATE:
    ...
    case Protocol::I_AccountModelUpdateMessage::REMOVE:
