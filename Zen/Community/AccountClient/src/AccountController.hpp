...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_CLIENT_ACCOUNT_CONTROLLER_HPP_INCLUDED
#define ZEN_COMMUNITY_CLIENT_ACCOUNT_CONTROLLER_HPP_INCLUDED
...
public:
    ...
    /// @{
public:
    AccountModelProxy& getModel() const;
    /// @}
...
#endif // ZEN_COMMUNITY_CLIENT_ACCOUNT_CONTROLLER_HPP_INCLUDED
