...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_ACCOUNTCLIENT_GROUP_HPP_INCLUDED
#define ZEN_COMMUNITY_ACCOUNTCLIENT_GROUP_HPP_INCLUDED
...
public:
    ...
    /// @{
protected:
    friend class GroupModelProxy;
             Group(AccountService& _parent);
public:
    virtual ~Group();
    /// @}
...
#endif // ZEN_COMMUNITY_ACCOUNTCLIENT_GROUP_HPP_INCLUDED
