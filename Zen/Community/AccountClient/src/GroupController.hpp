...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_CLIENT_GROUP_CONTROLLER_HPP_INCLUDED
#define ZEN_COMMUNITY_CLIENT_GROUP_CONTROLLER_HPP_INCLUDED
...
public:
    ...
    /// @{
public:
    GroupModelProxy& getModel() const;
    /// @}
...
#endif // ZEN_COMMUNITY_CLIENT_GROUP_CONTROLLER_HPP_INCLUDED
