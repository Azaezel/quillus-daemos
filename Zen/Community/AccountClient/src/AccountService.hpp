...
public:
    ...
    void handleSubscribeAccountModelResponse(pResponse_type _pResponse, Protocol::I_SubscribeAccountModelRequest& _request, AccountModelProxy::ProxySubscription* _pProxySubscription);
    void handleUnsubscribeAccountModelResponse(pResponse_type _pResponse, Protocol::I_UnsubscribeAccountModelRequest& _request, pAccountView_type _pAccountView);
    void handleSubscribeGroupModelResponse(pResponse_type _pResponse, Protocol::I_SubscribeGroupModelRequest& _request, GroupModelProxy::ProxySubscription* _pProxySubscription);
    void handleUnsubscribeGroupModelResponse(pResponse_type _pResponse, Protocol::I_UnsubscribeGroupModelRequest& _request, pGroupView_type _pGroupView);

    void handleCreateAccountResponse(pResponse_type _pResponse, Protocol::I_CreateAccountRequest& _request, AccountModelProxy::ProxyAccount* _pProxyAccount);
    void handleReadAccountResponse(pResponse_type _pResponse, Protocol::I_ReadAccountRequest& _request, AccountModelProxy::ProxyAccount* _pProxyAccount);
    void handleUpdateAccountResponse(pResponse_type _pResponse, Protocol::I_UpdateAccountRequest& _request, AccountModelProxy::ProxyAccount* _pProxyAccount);
    void handleDeleteAccountResponse(pResponse_type _pResponse, Protocol::I_DeleteAccountRequest& _request, AccountModelProxy::ProxyAccount* _pProxyAccount);

    void handleCreateGroupResponse(pResponse_type _pResponse, Protocol::I_CreateGroupRequest& _request, GroupModelProxy::ProxyGroup* _pProxyGroup);
    void handleReadGroupResponse(pResponse_type _pResponse, Protocol::I_ReadGroupRequest& _request, GroupModelProxy::ProxyGroup* _pProxyGroup);
    void handleUpdateGroupResponse(pResponse_type _pResponse, Protocol::I_UpdateGroupRequest& _request, GroupModelProxy::ProxyGroup* _pProxyGroup);
    void handleDeleteGroupResponse(pResponse_type _pResponse, Protocol::I_DeleteGroupRequest& _request, GroupModelProxy::ProxyGroup* _pProxyGroup);
