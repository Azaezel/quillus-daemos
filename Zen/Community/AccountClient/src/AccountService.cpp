...
AccountService::prepareToStart(Zen::Threading::ThreadPool& _threadPool)
{
    ...
    registerMessageHandler(Protocol::I_AccountModelUpdateMessage::getStaticMessageType(),
        boost::bind(&AccountService::handleAccountModelUpdateMessage, this, _1));

    registerMessageHandler(Protocol::I_GroupModelUpdateMessage::getStaticMessageType(),
        boost::bind(&AccountService::handleGroupModelUpdateMessage, this, _1));

    throw Zen::Utility::runtime_exception("AccountService::prepareToStart(): TODO Finish");
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void 
AccountService::handleSubscribeAccountModelResponse(pResponse_type _pResponse, Protocol::I_SubscribeAccountModelRequest& _request, AccountModelProxy::ProxySubscription* _pProxySubscription)
{
    // _pView is the payload associated with the original _request.
    // Handle this response.

    Protocol::I_SubscribeAccountModelResponse* pResponse =
        dynamic_cast<Protocol::I_SubscribeAccountModelResponse*>(_pResponse.get());
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void 
AccountService::handleUnsubscribeAccountModelResponse(pResponse_type _pResponse, Protocol::I_UnsubscribeAccountModelRequest& _request, pAccountView_type _pAccountView)
{
    // _pView is the payload associated with the original _request.
    // Handle this response.

    Protocol::I_UnsubscribeAccountModelResponse* pResponse =
        dynamic_cast<Protocol::I_UnsubscribeAccountModelResponse*>(_pResponse.get());
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void 
AccountService::handleSubscribeGroupModelResponse(pResponse_type _pResponse, Protocol::I_SubscribeGroupModelRequest& _request, GroupModelProxy::ProxySubscription* _pProxySubscription)
{
    // _pView is the payload associated with the original _request.
    // Handle this response.

    Protocol::I_SubscribeGroupModelResponse* pResponse =
        dynamic_cast<Protocol::I_SubscribeGroupModelResponse*>(_pResponse.get());
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void 
AccountService::handleUnsubscribeGroupModelResponse(pResponse_type _pResponse, Protocol::I_UnsubscribeGroupModelRequest& _request, pGroupView_type _pGroupView)
{
    // _pView is the payload associated with the original _request.
    // Handle this response.

    Protocol::I_UnsubscribeGroupModelResponse* pResponse =
        dynamic_cast<Protocol::I_UnsubscribeGroupModelResponse*>(_pResponse.get());
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void 
AccountService::handleCreateAccountResponse(pResponse_type _pResponse, Protocol::I_CreateAccountRequest& _request, AccountModelProxy::ProxyAccount* _pProxyAccount)
{
    // _pAccount is the payload associated with the original _request.
    // Handle this response.

    Protocol::I_CreateAccountResponse* pResponse =
        dynamic_cast<Protocol::I_CreateAccountResponse*>(_pResponse.get());
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void 
AccountService::handleReadAccountResponse(pResponse_type _pResponse, Protocol::I_ReadAccountRequest& _request, AccountModelProxy::ProxyAccount* _pProxyAccount)
{
    // _pAccount is the payload associated with the original _request.
    // Handle this response.

    Protocol::I_ReadAccountResponse* pResponse =
        dynamic_cast<Protocol::I_ReadAccountResponse*>(_pResponse.get());
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void 
AccountService::handleUpdateAccountResponse(pResponse_type _pResponse, Protocol::I_UpdateAccountRequest& _request, AccountModelProxy::ProxyAccount* _pProxyAccount)
{
    // _pAccount is the payload associated with the original _request.
    // Handle this response.

    Protocol::I_UpdateAccountResponse* pResponse =
        dynamic_cast<Protocol::I_UpdateAccountResponse*>(_pResponse.get());
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void 
AccountService::handleDeleteAccountResponse(pResponse_type _pResponse, Protocol::I_DeleteAccountRequest& _request, AccountModelProxy::ProxyAccount* _pProxyAccount)
{
    // _pAccount is the payload associated with the original _request.
    // Handle this response.

    Protocol::I_DeleteAccountResponse* pResponse =
        dynamic_cast<Protocol::I_DeleteAccountResponse*>(_pResponse.get());
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void 
AccountService::handleCreateGroupResponse(pResponse_type _pResponse, Protocol::I_CreateGroupRequest& _request, GroupModelProxy::ProxyGroup* _pProxyGroup)
{
    // _pGroup is the payload associated with the original _request.
    // Handle this response.

    Protocol::I_CreateGroupResponse* pResponse =
        dynamic_cast<Protocol::I_CreateGroupResponse*>(_pResponse.get());
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void 
AccountService::handleReadGroupResponse(pResponse_type _pResponse, Protocol::I_ReadGroupRequest& _request, GroupModelProxy::ProxyGroup* _pProxyGroup)
{
    // _pGroup is the payload associated with the original _request.
    // Handle this response.

    Protocol::I_ReadGroupResponse* pResponse =
        dynamic_cast<Protocol::I_ReadGroupResponse*>(_pResponse.get());
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void 
AccountService::handleUpdateGroupResponse(pResponse_type _pResponse, Protocol::I_UpdateGroupRequest& _request, GroupModelProxy::ProxyGroup* _pProxyGroup)
{
    // _pGroup is the payload associated with the original _request.
    // Handle this response.

    Protocol::I_UpdateGroupResponse* pResponse =
        dynamic_cast<Protocol::I_UpdateGroupResponse*>(_pResponse.get());
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void 
AccountService::handleDeleteGroupResponse(pResponse_type _pResponse, Protocol::I_DeleteGroupRequest& _request, GroupModelProxy::ProxyGroup* _pProxyGroup)
{
    // _pGroup is the payload associated with the original _request.
    // Handle this response.

    Protocol::I_DeleteGroupResponse* pResponse =
        dynamic_cast<Protocol::I_DeleteGroupResponse*>(_pResponse.get());
...
{
    Protocol::I_AccountModelUpdateMessage* pMessage =
        dynamic_cast<Protocol::I_AccountModelUpdateMessage*>(_pMessage.get());
