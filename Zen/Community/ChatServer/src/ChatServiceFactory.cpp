...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
ChatServiceFactory::destroy(wpApplicationService_type _pChatService)
{
    ChatService* pRaw = dynamic_cast<ChatService*>(_pChatService.get());
    ...
    {
        throw Zen::Utility::runtime_exception("ChatServiceFactory::destroy(): Invalid type.");
    }
}

//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
ChatServiceFactory::pApplicationService_type
ChatServiceFactory::create(Zen::Enterprise::AppServer::I_ApplicationServer& _appServer, const std::string& _type)
{
    ChatService* pRawService = new ChatService(_appServer);
