...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
UserInfo::pObjectCollection_type
UserInfo::getChildObjects(pObjectType_type _pType,
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
UserInfo::setField(const std::string& _key, const boost::any& _value)
{
    throw Zen::Utility::runtime_exception("Not implemented.");
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
const boost::any&
UserInfo::getField(const std::string& _key) const
{
    throw Zen::Utility::runtime_exception("Not implemented.");
}
