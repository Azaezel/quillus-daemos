...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
UserPermissions::pObjectCollection_type
UserPermissions::getChildObjects(pObjectType_type _pType,
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
void
UserPermissions::setPermission(const std::string& _key, bool _value)
{
    throw Zen::Utility::runtime_exception("Not implemented.");
}
...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
bool
UserPermissions::getPermission(const std::string& _key) const
{
    throw Zen::Utility::runtime_exception("Not implemented.");
}
