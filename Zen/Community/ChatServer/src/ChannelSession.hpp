...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_CHAT_SERVER_CHANNEL_SESSION_HPP_INCLUDED
#define ZEN_COMMUNITY_CHAT_SERVER_CHANNEL_SESSION_HPP_INCLUDED
...
#endif // ZEN_COMMUNITY_CHAT_SERVER_CHANNEL_SESSION_HPP_INCLUDED
