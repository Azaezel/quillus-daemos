...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_SERVER_CHANNEL_CONTROLLER_HPP_INCLUDED
#define ZEN_COMMUNITY_SERVER_CHANNEL_CONTROLLER_HPP_INCLUDED
...
#endif // ZEN_COMMUNITY_SERVER_CHANNEL_CONTROLLER_HPP_INCLUDED
