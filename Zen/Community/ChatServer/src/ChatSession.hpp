...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_CHAT_SERVER_CHAT_SESSION_HPP_INCLUDED
#define ZEN_COMMUNITY_CHAT_SERVER_CHAT_SESSION_HPP_INCLUDED
...
#endif // ZEN_COMMUNITY_CHAT_SERVER_CHAT_SESSION_HPP_INCLUDED
