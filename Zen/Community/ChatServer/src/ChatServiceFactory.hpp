...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_CHATSERVER_CHAT_SERVICE_FACTORY_HPP_INCLUDED
#define ZEN_COMMUNITY_CHATSERVER_CHAT_SERVICE_FACTORY_HPP_INCLUDED
...
public:
    ...
    /// @name ChatServiceFactory implementation
    /// @{
private:
...
public:
    ...
    static ChatServiceFactory& getSingleton();
    /// @}
...
#endif // ZEN_COMMUNITY_CHATSERVER_CHAT_SERVICE_FACTORY_HPP_INCLUDED
