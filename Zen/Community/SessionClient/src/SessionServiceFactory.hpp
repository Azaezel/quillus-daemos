...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_COMMUNITY_SESSIONCLIENT_SESSION_SERVICE_FACTORY_HPP_INCLUDED
#define ZEN_COMMUNITY_SESSIONCLIENT_SESSION_SERVICE_FACTORY_HPP_INCLUDED
...
#endif // ZEN_COMMUNITY_SESSIONCLIENT_SESSION_SERVICE_FACTORY_HPP_INCLUDED
